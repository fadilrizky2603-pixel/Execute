...
YCMD:cameditor(playerid, params[])
{
...
YCMD:MyCommand(playerid, params[]) = stopcam;
YCMD:testajalah(playerid, params[]) {
	Command_ReProcess(playerid, "stopcam", help);
	return 1;
}
