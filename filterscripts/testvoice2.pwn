...
public OnPlayerConnect(playerid)
{
    ...
    {
        new lstring[512];
        format(lstring, sizeof(lstring), ""WHITE"Dari: Penjaga kota DCRP Roleplay\nKepada: Warga (pemain peran) di Kota DCRP Roleplay, "RED"%s\n\n"WHITE"Untuk bermain peran di DCRP Roleplay, maka anda harus memenuhi syarat yaitu memasang Plugin Voice anda.", GetName(playerid));
        ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""DCRP"DCRP Roleplay "WHITE"- Plugin Tidak Terdeteksi", lstring, "Keluar", "");
    ...
    {
        new lstring[512];
        format(lstring, sizeof(lstring), ""WHITE"Dari: Penjaga kota DCRP Roleplay\nKepada: Warga (pemain peran) di Kota DCRP Roleplay, "RED"%s\n\n"WHITE"Untuk bermain peran di DCRP Roleplay, maka anda harus memenuhi syarat yaitu mengaktifkan Voice Sistem anda.", GetName(playerid));
        ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""DCRP"DCRP Roleplay "WHITE"- Mic Tidak Terdeteksi", lstring, "Keluar", "");
...
public OnFilterScriptInit()
{
    ...
    print("-------------------- [DCRP Voice Chat System] --------------------\
    \n===>> Berhasil dimuat dengan baik!\
    \n===>> by: Murozxz (DCRP)\
    \n===>> dipersembahkan untuk DCRP\
    \n-----------------------------------------------------------------");
    return 1;
}
