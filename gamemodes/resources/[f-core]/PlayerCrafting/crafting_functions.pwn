...
hook OnScriptInit()
{
    ...
    Stuff_Craft[CraftingLabel] = CreateDynamic3DTextLabel(""GREEN"[ALT]"WHITE" Crafting", -1, -2140.4128, -244.7229, 36.5156, 20.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 0, 0, 0, -1, 20.0, -1, 0);
}
...
public Kevlar(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 20)
    {
        ...
        ItemDelete(playerid, "Material", 50);
        ItemDelete(playerid, "Besi", 100);
        ItemDelete(playerid, "Kayu Kemas", 100);
        ItemDelete(playerid, "Pakaian", 100);
        ItemAdd(playerid, "Kevlar", 1);
        ShowItemBox(playerid, "Kevlar", "Received_1x", 2);
        ShowItemBox(playerid, "Material", "Removed_50x", 2);
        ShowItemBox(playerid, "Besi", "Removed_100x", 2);
        ShowItemBox(playerid, "Kayu Kemas", "Removed_100x", 2);
        ShowItemBox(playerid, "Pakaian", "Removed_100x", 2);
    }
    else 
    {
...
public Colt(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 20)
    {
        ...
        ItemDelete(playerid, "Material", 80);
        ItemDelete(playerid, "Tembaga", 120);
        ItemDelete(playerid, "Baja", 25);
        ItemDelete(playerid, "Kayu Kemas", 8);

        GivePlayerWeaponEx(playerid, 22, 150);
		ShowItemBox(playerid, "Colt-45", "Received_1x", 2);
        ShowItemBox(playerid, "Material", "Removed_80x", 2);
        ShowItemBox(playerid, "Tembaga", "Removed_120x", 2);
        ShowItemBox(playerid, "Kayu Kemas", "Removed_8x", 2);
        ShowItemBox(playerid, "Baja", "Removed_25x", 2);
    }
    else 
    {
        AccountData[playerid][ActivityTime] ++;
...
public DesertE(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 20)
    {
        ...
        ItemDelete(playerid, "Material", 250);
        ItemDelete(playerid, "Baja", 60);
        ItemDelete(playerid, "Kaca", 10);
        ItemDelete(playerid, "Kayu Kemas", 20);

        GivePlayerWeaponEx(playerid, 24, 150);
		ShowItemBox(playerid, "Desert Eagle", "Received_1x", 2);
        ShowItemBox(playerid, "Material", "Removed_250x", 2);
        ShowItemBox(playerid, "Baja", "Removed_60x", 2);
        ShowItemBox(playerid, "Kayu Kemas", "Removed_20x", 2);
        ShowItemBox(playerid, "Kaca", "Removed_10x", 2);
    }
    else 
    {
        AccountData[playerid][ActivityTime] ++;
...
public Shotgun(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 120)
    {
        ...
        ItemDelete(playerid, "Material", 400);
        ItemDelete(playerid, "Besi", 350);
        ItemDelete(playerid, "Tembaga", 250);
        ItemDelete(playerid, "Berlian", 8);
        ItemDelete(playerid, "Baja", 75);
        ItemDelete(playerid, "Alumunium", 150);
        ItemDelete(playerid, "Kaca", 30);
        ItemDelete(playerid, "Kayu Kemas", 100);

        GivePlayerWeaponEx(playerid, 25, 200);
		ShowItemBox(playerid, "Shotgun", "Received_1x", 2);
        ShowItemBox(playerid, "Material", "Removed_400x", 2);
        ShowItemBox(playerid, "Besi", "Removed_350x", 2);
        ShowItemBox(playerid, "Tembaga", "Removed_250x", 2);
        ShowItemBox(playerid, "Berlian", "Removed_8x", 2);
        ShowItemBox(playerid, "Baja", "Removed_75x", 2);
        ShowItemBox(playerid, "Aluminium", "Removed_150x", 2);
        ShowItemBox(playerid, "Kaca", "Removed_30x", 2);
        ShowItemBox(playerid, "Kayu Kemas", "Removed_100x", 2);
    }
    else 
    {
...
public Mp5(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 120)
    {
        ...
        ItemDelete(playerid, "Material", 250);
        ItemDelete(playerid, "Kayu Kemas", 160);
        ItemDelete(playerid, "Baja", 70);
        ItemDelete(playerid, "Alumunium", 75);

        GivePlayerWeaponEx(playerid, 29, 250);
		ShowItemBox(playerid, "MP5", "Received_1x", 2);
        ShowItemBox(playerid, "Material", "Removed_250x", 2);
        ShowItemBox(playerid, "Kayu Kemas", "Removed_160x", 2);
        ShowItemBox(playerid, "Baja", "Removed_70x", 2);
        ShowItemBox(playerid, "Aluminium", "Removed_75x", 2);
    }
    else 
    {
        AccountData[playerid][ActivityTime] += 10;
...
public Ak47(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 20)
    {
        ...
        ItemDelete(playerid, "Material", 350);
        ItemDelete(playerid, "Kayu Kemas", 200);
        ItemDelete(playerid, "Baja", 150);

        GivePlayerWeaponEx(playerid, 30, 250);
		ShowItemBox(playerid, "AK-47", "Received_1x", 2);
        ShowItemBox(playerid, "Material", "Removed_350x", 2);
        ShowItemBox(playerid, "Kayu Kemas", "Removed_200x", 2);
        ShowItemBox(playerid, "Baja", "Removed_150x", 2);
    }
    else 
    {
        AccountData[playerid][ActivityTime] ++;
...
public Tec9(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 20)
    {
        ...
        ItemDelete(playerid, "Material", 450);
        ItemDelete(playerid, "Besi", 100);
        ItemDelete(playerid, "Baja", 75);
        ItemDelete(playerid, "Alumunium", 60);
        ItemDelete(playerid, "Tembaga", 500);
        ItemDelete(playerid, "Emas", 30);
        ItemDelete(playerid, "Berlian", 10);

        GivePlayerWeaponEx(playerid, 32, 200);
		ShowItemBox(playerid, "TEC-9", "Received_1x", 2);
        ShowItemBox(playerid, "Material", "Removed_450x", 2);
        ShowItemBox(playerid, "Besi", "Removed_100x", 2);
        ShowItemBox(playerid, "Baja", "Removed_75x", 2);
        ShowItemBox(playerid, "Aluminium", "Removed_60x", 2);
        ShowItemBox(playerid, "Tembaga", "Removed_500x", 2);
        ShowItemBox(playerid, "Emas", "Removed_30x", 2);
        ShowItemBox(playerid, "Berlian", "Removed_10x", 2);
    }
    else 
    {
        AccountData[playerid][ActivityTime] ++;
    ...
    if(newkeys & KEY_WALK && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        if(IsPlayerInDynamicArea(playerid, Stuff_Craft[CraftingArea]))
        {
            ...
            if(countpd >= 4 && countems >= 2)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_CRAFTING, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Crafting", 
                "Kevlar\
                \n"GRAY"Colt 45\
                \nDesert Eagle\
                \n"GRAY"Shotgun\
...
Dialog:DIALOG_CRAFTPASS(playerid, response, listitem, inputtext[])
{
    ...
    if(isnull(inputtext)) return Dialog_Show(playerid, DIALOG_CRAFTPASS, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Crafting Password",
    ...
    if(IsNumeric(inputtext)) if(isnull(inputtext)) return Dialog_Show(playerid, DIALOG_CRAFTPASS, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Crafting Password",
    "Error: Tidak dapat diisi angka!\nMohon masukkan kata kunci / sandi jika ingin Crafting senjata tersebut dengan benar:", "Input", "Batal");
    
    new jskc[600];
    if(!strcmp(inputtext, "mafiapentolayam", true))
    {
        switch(AccountData[playerid][pTempValue])
        {
            case 3: // Shotgun
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_CRAFTINGCONF, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Crafting", jskc, "Iya", "Tidak");
            }
            case 4: // MP5
            {
                format(jskc, sizeof(jskc), ""WHITE"Anda akan membuat "RED"MP5"WHITE" dengan bahan sebagai berikut\
                \n\nMaterial: "ORANGE"%d/250\
                \n"WHITE"Kayu Kemas: "ORANGE"%d/160\
                \n"WHITE"Baja: "ORANGE"%d/70\
                \n"WHITE"Alumunium: "ORANGE"%d/75\
                ...
                Inventory_Count(playerid, "Baja"), Inventory_Count(playerid, "Alumunium"));
                ShowPlayerDialog(playerid, DIALOG_CRAFTINGCONF, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Crafting", jskc, "Iya", "Tidak");
            }
            case 5: // AK
            {
    ...
    switch(dialogid)
    {
        case DIALOG_CRAFTING:
        {
            ...
            switch(listitem)
            {
                ...
                case 3:// Shotgun
                {
                    Dialog_Show(playerid, DIALOG_CRAFTPASS, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Crafting Password",
                    "Mohon masukkan kata kunci / sandi jika ingin Crafting senjata tersebut dengan benar:", "Input", "Batal");
                }
                case 4:// MP5
                {
        ...
        case DIALOG_CRAFTINGCONF:
        {
            ...
            switch(AccountData[playerid][pTempValue])
            {
                case 0: //kevlar
				{
                    ...
                    PlayerTextDrawSetString(playerid, ProgressBar[playerid][1], "CRAFTING");
				...
				{
                    if(Inventory_Count(playerid, "Material") < 250) return ShowTDN(playerid, NOTIFICATION_ERROR, "Material tidak cukup, butuh 250!");
                    if(Inventory_Count(playerid, "Kayu Kemas") < 160) return ShowTDN(playerid, NOTIFICATION_ERROR, "Kayu Kemas tidak cukup, butuh 160!");
                    if(Inventory_Count(playerid, "Baja") < 70) return ShowTDN(playerid, NOTIFICATION_ERROR, "Baja tidak cukup, butuh 70!");
                    if(Inventory_Count(playerid, "Alumunium") < 75) return ShowTDN(playerid, NOTIFICATION_ERROR, "Alumunium tidak cukup, butuh 75!");

                    AccountData[playerid][ActivityTime] = 1;
					pTimerCrafting[playerid] = SetTimerEx("Mp5", 1000, true, "d", playerid);
                    PlayerTextDrawSetString(playerid, ProgressBar[playerid][1], "CRAFTING");
                    ShowProgressBar(playerid);
                    ApplyAnimation(playerid, "BD_FIRE", "wash_up", 4.1, 1, 0, 0, 0, 0, 1);
				}
