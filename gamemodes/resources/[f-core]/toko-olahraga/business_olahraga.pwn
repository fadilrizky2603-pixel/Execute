...
hook OnGameModeInit()
{
    CreateDynamic3DTextLabel(""GREEN"[ALT]"WHITE" Akses Toko Olahraga", -1, 1386.4347, 293.3129, 19.5469 + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1);
}
...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(newkeys & KEY_WALK && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        if(IsPlayerInRangeOfPoint(playerid, 2.5, 1386.4347, 293.3129, 19.5469))
        {
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_SPORTSTORE, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Toko Olahraga", 
                "Nama Item\tHarga\
                \nStick Golf\t$2500\
        ...
        case DIALOG_SPORTSTORE:
        {
            ...
            switch(listitem)
            {
                case 0://Stick Golf
                {
                    ...
                    ShowItemBox(playerid, "Uang", "Removed_$2500", 2);
                ...
                case 1://Baseball
                {
                    ...
                    TakeMoney(playerid, value);
                    GivePlayerWeaponEx(playerid, weaponid, ammo);
                    ShowItemBox(playerid, "Uang", "Removed_$3000", 2);
                ...
                case 3://Pisau
                {
                    ...
                    TakeMoney(playerid, value);
                    GivePlayerWeaponEx(playerid, weaponid, ammo);
                    ShowItemBox(playerid, "Uang", "Removed_$5000", 2);
                ...
                case 5://Stick Billiard
                {
                    ...
                    TakeMoney(playerid, value);
                    GivePlayerWeaponEx(playerid, weaponid, ammo);
                    ShowItemBox(playerid, "Uang", "Removed_$4000", 2);
                ...
                case 6://Katana
                {
                    ...
                    TakeMoney(playerid, value);
                    GivePlayerWeaponEx(playerid, weaponid, ammo);
                    ShowItemBox(playerid, "Uang", "Removed_$10000", 2);
