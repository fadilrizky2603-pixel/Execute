    ...
    if (newkeys & KEY_WALK)
    {
        ...
        else if(GetPVarInt(playerid, "DurringGym")) // Angkat Barbel
        {
            if(GymType[playerid] == 1)
            {
                ...
                {
                    GymTimer[playerid] = SetTimerEx("AngkatBarbel", 700, false, "d", playerid);
                }
            }
            else if(GymType[playerid] == 2) // Sepeda
            {
                if(!GymTimer[playerid])
                {
                    GymTimer[playerid] = SetTimerEx("SepedaGym", 800, false, "d", playerid);
                }
            }
            ...
            else if(GymType[playerid] == 4) // Barbel Kecil
            {
                if(!GymTimer[playerid])
                {
                    GymTimer[playerid] = SetTimerEx("BarbelKecilGym", 800, false, "d", playerid);
                }
            }
        }
    }
