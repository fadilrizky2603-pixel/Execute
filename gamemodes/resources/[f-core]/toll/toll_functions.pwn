...
new BarrierInfo[10][brInfo] =
{
    ...
    {TEAM_NONE,     53.228298, 		-1526.655273, 	4.250699,	-100.753540,    false, -1},//kord 
	{TEAM_NONE, 	51.0793,		-1536.5345,		4.3442,		81.9535,    false, -1}, // kord 1
...
hook OnGameModeInit()
{
	CreateDynamic3DTextLabel(""PINK1"[Gerbang Toll Point]\n"LIGHTGREY"Gunakan tombol "YELLOW"H"LIGHTGREY" (klakson) untuk membuka gerbang!", -1, 47.4731, -1539.7279, 4.9482 + 0.55, 6.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1);
	CreateDynamic3DTextLabel(""PINK1"[Gerbang Toll Point]\n"LIGHTGREY"Gunakan tombol "YELLOW"H"LIGHTGREY" (klakson) untuk membuka gerbang!", -1, 57.7769, -1524.0504, 4.7484 + 0.55, 6.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1);
	CreateDynamic3DTextLabel(""PINK1"[Gerbang Toll Point]\n"LIGHTGREY"Gunakan tombol "YELLOW"H"LIGHTGREY" (klakson) untuk membuka gerbang!", -1, 537.2600, 454.4145, 18.5988 + 0.55, 6.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1);
	CreateDynamic3DTextLabel(""PINK1"[Gerbang Toll Point]\n"LIGHTGREY"Gunakan tombol "YELLOW"H"LIGHTGREY" (klakson) untuk membuka gerbang!", -1, 500.0012, 496.6064, 18.5911 + 0.55, 6.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1);
	CreateDynamic3DTextLabel(""PINK1"[Gerbang Toll Point]\n"LIGHTGREY"Gunakan tombol "YELLOW"H"LIGHTGREY" (klakson) untuk membuka gerbang!", -1, -173.5992, 358.3904, 12.1705 + 0.55, 6.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1);
	CreateDynamic3DTextLabel(""PINK1"[Gerbang Toll Point]\n"LIGHTGREY"Gunakan tombol "YELLOW"H"LIGHTGREY" (klakson) untuk membuka gerbang!", -1, -179.0582, 312.7829, 12.1705 + 0.55, 6.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1);
	CreateDynamic3DTextLabel(""PINK1"[Gerbang Toll Point]\n"LIGHTGREY"Gunakan tombol "YELLOW"H"LIGHTGREY" (klakson) untuk membuka gerbang!", -1, 579.8929, -1136.4073, 25.5710 + 0.55, 6.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1);
	CreateDynamic3DTextLabel(""PINK1"[Gerbang Toll Point]\n"LIGHTGREY"Gunakan tombol "YELLOW"H"LIGHTGREY" (klakson) untuk membuka gerbang!", -1, 559.2356, -1151.5155, 27.5269 + 0.55, 6.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1);
	CreateDynamic3DTextLabel(""PINK1"[Gerbang Toll Point]\n"LIGHTGREY"Gunakan tombol "YELLOW"H"LIGHTGREY" (klakson) untuk membuka gerbang!", -1, 1736.3079, 491.6081, 29.4648 + 0.55, 6.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1);
	CreateDynamic3DTextLabel(""PINK1"[Gerbang Toll Point]\n"LIGHTGREY"Gunakan tombol "YELLOW"H"LIGHTGREY" (klakson) untuk membuka gerbang!", -1, 1724.9844, 508.3641, 28.9483 + 0.55, 6.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1);
    return 1;
}
