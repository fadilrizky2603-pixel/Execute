...
LoadVarsButcher(playerid)
{
    ...
    PlayerChickenVars[playerid][ButcherStartLabel] = CreateDynamic3DTextLabel(""GREEN"[ALT]"WHITE"- Mulai Pekerjaan", 0xFFFFFFFF, 1537.7798, 14.9313,  24.1406, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, playerid, 10.0, -1, 0);
    PlayerChickenVars[playerid][ButcherProcessLabel][0] = CreateDynamic3DTextLabel(""GREEN"[ALT]"WHITE"- Memotong Ayam", 0xFFFFFFFF, 1925.6368, 135.9666, 37.3512, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, playerid, 10.0, -1, 0);
    PlayerChickenVars[playerid][ButcherProcessLabel][1] = CreateDynamic3DTextLabel(""GREEN"[ALT]"WHITE"- Memotong Ayam", 0xFFFFFFFF, 1921.9147, 137.1642, 37.3512, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, playerid, 10.0, -1, 0);
    PlayerChickenVars[playerid][ButcherProcessLabel][2] = CreateDynamic3DTextLabel(""GREEN"[ALT]"WHITE"- Memotong Ayam", 0xFFFFFFFF, 1917.5660, 138.5687, 37.3512, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, playerid, 10.0, -1, 0);
    PlayerChickenVars[playerid][ButcherProcessLabel][3] = CreateDynamic3DTextLabel(""GREEN"[ALT]"WHITE"- Memotong Ayam", 0xFFFFFFFF, 1913.5212, 139.9623, 37.3512, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, playerid, 10.0, -1, 0);
    PlayerChickenVars[playerid][ButcherPackLabel][0] = CreateDynamic3DTextLabel(""GREEN"[ALT]"WHITE"- Kemas Ayam", 0xFFFFFFFF, 1942.7374, 144.3086, 37.3512, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, playerid, 10.0, -1, 0);
    PlayerChickenVars[playerid][ButcherPackLabel][1] = CreateDynamic3DTextLabel(""GREEN"[ALT]"WHITE"- Kemas Ayam", 0xFFFFFFFF, 1944.2256, 148.7797, 37.3512, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, playerid, 10.0, -1, 0);
    PlayerChickenVars[playerid][ButcherPackLabel][2] = CreateDynamic3DTextLabel(""GREEN"[ALT]"WHITE"- Kemas Ayam", 0xFFFFFFFF, 1945.5770, 152.8428, 37.3512, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, playerid, 10.0, -1, 0);
    PlayerChickenVars[playerid][ButcherPackLabel][3] = CreateDynamic3DTextLabel(""GREEN"[ALT]"WHITE"- Kemas Ayam", 0xFFFFFFFF, 1951.6533, 150.8964, 37.3512, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, playerid, 10.0, -1, 0);
    PlayerChickenVars[playerid][ButcherPackLabel][4] = CreateDynamic3DTextLabel(""GREEN"[ALT]"WHITE"- Kemas Ayam", 0xFFFFFFFF, 1950.1649, 146.4068, 37.3512, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, playerid, 10.0, -1, 0);
    PlayerChickenVars[playerid][ButcherPackLabel][5] = CreateDynamic3DTextLabel(""GREEN"[ALT]"WHITE"- Kemas Ayam", 0xFFFFFFFF, 1948.6040, 141.7282, 37.3512, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, playerid, 10.0, -1, 0);
...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(newkeys & KEY_WALK && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        if(AccountData[playerid][pJob] == JOB_BUTCHER)
        {
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_AYAM_START, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Tukang Ayam",
            ...
            if(IsPlayerInDynamicArea(playerid, PlayerChickenVars[playerid][ButcherTakeChicken]) && PlayerChickenVars[playerid][DurringButcher])
            {
                ...
                PlayerTextDrawSetString(playerid, ProgressBar[playerid][1], "MENGAMBIL AYAM");
            ...
            for(new x = 0; x < 4; x ++)
            {
                if(IsPlayerInDynamicArea(playerid, PlayerChickenVars[playerid][ButcherProcessArea][x]))
                {
                    ...
                    if(Inventory_Count(playerid, "Ayam Potong") >= 100) return ShowTDN(playerid, NOTIFICATION_ERROR, "Tidak dapat membawa Ayam Potong lebih dari 100!");

                    AccountData[playerid][ActivityTime] = 1;
                    PlayerTextDrawSetString(playerid, ProgressBar[playerid][1], "MEMOTONG AYAM");
                    ShowProgressBar(playerid);
            ...
            for(new x = 0; x < 6; x ++)
            {
                if(IsPlayerInDynamicArea(playerid, PlayerChickenVars[playerid][ButcherPackArea][x]))
                {
                    ...
                    if(Inventory_Count(playerid, "Ayam Kemas") >= 100) return ShowTDN(playerid, NOTIFICATION_ERROR, "Tidak dapat membawa Ayam Kemas lebih dari 100!");

                    AccountData[playerid][ActivityTime] = 1;
                    PlayerTextDrawSetString(playerid, ProgressBar[playerid][1], "PACKING AYAM");
                    ShowProgressBar(playerid);
...
public ChickenPacking(playerid, x)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 12)
    {
        ...
        ItemDelete(playerid, "Ayam Potong", 1);
        ItemAdd(playerid, "Ayam Kemas", 2);
        ShowItemBox(playerid, "Ayam Potong", "Removed_1x", 2);
        ShowItemBox(playerid, "Ayam Kemas", "Received_2x", 2);
    ...
    else
    {
        ...
        progressvalue = AccountData[playerid][ActivityTime] * 67/12;
...
public ChickenProcessed(playerid, x)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 15)
    {
        ...
        ItemDelete(playerid, "Ayam Hidup");
        ItemAdd(playerid, "Ayam Potong", 2);
        ShowItemBox(playerid, "Ayam Hidup", "Removed_1x", 2);
        ShowItemBox(playerid, "Ayam Potong", "Received_2x", 2);
...
public ChickenTake(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 10)
    {
        ...
        ItemAdd(playerid, "Ayam Hidup");
        ShowItemBox(playerid, "Ayam Hidup", "Received_1x", 2);
        GivePlayerXP(playerid, DEFAULT_XP);
    }
    else
    {
