...
public TakePadi(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 150)
    {
        ...
        ItemAdd(playerid, "Padi", 4);
        ShowItemBox(playerid, "Padi", "Received_4x", 2);
...
public TakeCabai(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 150)
    {
        ...
        ItemAdd(playerid, "Cabe", 4);
        ShowItemBox(playerid, "Cabe", "Received_4x", 2);
...
public TakeTebu(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 150)
    {
        ...
        ItemAdd(playerid, "Tebu", 4);
        ShowItemBox(playerid, "Tebu", "Received_4x", 2);
...
public ProcessGaram(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 120)
    {
        ...
        ItemDelete(playerid, "Garam Kristal");
        ItemDelete(playerid, "Botol", 1);
        ItemAdd(playerid, "Garam", 1);
        ShowItemBox(playerid, "Garam", "Received_1x", 2);
        ShowItemBox(playerid, "Garam Kristal", "Removed_1x", 2);
...
public ProcessBeras(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 120)
    {
        ...
        ItemDelete(playerid, "Padi");
        ItemDelete(playerid, "Kain", 1);
        ItemAdd(playerid, "Beras", 1);
        ShowItemBox(playerid, "Beras", "Received_1x", 2);
        ShowItemBox(playerid, "Padi", "Removed_1x", 2);
...
public ProcessGula(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 120)
    {
        ...
        ItemDelete(playerid, "Tebu");
        ItemDelete(playerid, "Kain", 1);
        ItemAdd(playerid, "Gula", 1);
        ShowItemBox(playerid, "Gula", "Received_1x", 2);
        ShowItemBox(playerid, "Tebu", "Removed_1x", 2);
        ShowItemBox(playerid, "Kain", "Removed_1x", 2);
    }
    else 
    {
...
public ProcessSambel(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 120)
    {
        ...
        ItemDelete(playerid, "Cabe");
        ItemDelete(playerid, "Botol", 1);
        ItemAdd(playerid, "Sambel", 1);
        ShowItemBox(playerid, "Sambel", "Received_1x", 2);
        ShowItemBox(playerid, "Cabe", "Removed_1x", 2);
        ShowItemBox(playerid, "Botol", "Removed_1x", 2);
    }
    else 
    {
...
public TakeSalt(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 150)
    {
        ...
        ItemAdd(playerid, "Garam Kristal", 5);
        ShowItemBox(playerid, "Garam Kristal", "Received_5x", 2);
