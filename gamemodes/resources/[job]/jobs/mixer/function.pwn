...
jobs_mixer_create_ptd(playerid)
{
    ...
    jobs::PBMixer[playerid][0] = CreatePlayerTextDraw(playerid, 200.000, 166.000, "Gambar teks baru");
    PlayerTextDrawLetterSize(playerid, jobs::PBMixer[playerid][0], 0.000, 1.500);
    PlayerTextDrawAlignment(playerid, jobs::PBMixer[playerid][0], 1);
    PlayerTextDrawColor(playerid, jobs::PBMixer[playerid][0], -1);
    PlayerTextDrawSetShadow(playerid, jobs::PBMixer[playerid][0], 1);
    PlayerTextDrawSetOutline(playerid, jobs::PBMixer[playerid][0], 1);
    PlayerTextDrawBackgroundColor(playerid, jobs::PBMixer[playerid][0], 150);
    PlayerTextDrawFont(playerid, jobs::PBMixer[playerid][0], 1);
    PlayerTextDrawSetProportional(playerid, jobs::PBMixer[playerid][0], 1);

    jobs::PBMixer[playerid][1] = CreatePlayerTextDraw(playerid, 220.000, 418.000, "LD_SPAC:white");
    PlayerTextDrawTextSize(playerid, jobs::PBMixer[playerid][1], 65.000, 18.000);
    PlayerTextDrawAlignment(playerid, jobs::PBMixer[playerid][1], 1);
    PlayerTextDrawColor(playerid, jobs::PBMixer[playerid][1], 572732586);
    PlayerTextDrawSetShadow(playerid, jobs::PBMixer[playerid][1], 0);
    PlayerTextDrawSetOutline(playerid, jobs::PBMixer[playerid][1], 0);
    PlayerTextDrawBackgroundColor(playerid, jobs::PBMixer[playerid][1], 255);
    PlayerTextDrawFont(playerid, jobs::PBMixer[playerid][1], 4);
    PlayerTextDrawSetProportional(playerid, jobs::PBMixer[playerid][1], 1);

    jobs::PBMixer[playerid][2] = CreatePlayerTextDraw(playerid, 222.000, 420.000, "LD_SPAC:white"); // PROGRESS SLUMP
    PlayerTextDrawTextSize(playerid, jobs::PBMixer[playerid][2], 61.000, 14.000);
    PlayerTextDrawAlignment(playerid, jobs::PBMixer[playerid][2], 1);
    PlayerTextDrawColor(playerid, jobs::PBMixer[playerid][2], -626712376);
    PlayerTextDrawSetShadow(playerid, jobs::PBMixer[playerid][2], 0);
    PlayerTextDrawSetOutline(playerid, jobs::PBMixer[playerid][2], 0);
    PlayerTextDrawBackgroundColor(playerid, jobs::PBMixer[playerid][2], 255);
    PlayerTextDrawFont(playerid, jobs::PBMixer[playerid][2], 4);
    PlayerTextDrawSetProportional(playerid, jobs::PBMixer[playerid][2], 1);

    jobs::PBMixer[playerid][3] = CreatePlayerTextDraw(playerid, 252.000, 405.000, "Slump");
    PlayerTextDrawLetterSize(playerid, jobs::PBMixer[playerid][3], 0.190, 1.299);
    PlayerTextDrawAlignment(playerid, jobs::PBMixer[playerid][3], 2);
    PlayerTextDrawColor(playerid, jobs::PBMixer[playerid][3], -1);
    PlayerTextDrawSetShadow(playerid, jobs::PBMixer[playerid][3], 0);
    PlayerTextDrawSetOutline(playerid, jobs::PBMixer[playerid][3], 0);
    PlayerTextDrawBackgroundColor(playerid, jobs::PBMixer[playerid][3], 150);
    PlayerTextDrawFont(playerid, jobs::PBMixer[playerid][3], 1);
    PlayerTextDrawSetProportional(playerid, jobs::PBMixer[playerid][3], 1);
}
...
FUNC::jobs_mixer_select_case(playerid, cases)
{
    ...
    ShowPlayerDialog(playerid, DIALOG_MIXER, DIALOG_STYLE_INPUT, "{FFB6C1}DCRP{FFFFFF} - Batching Plant", "Mohon masukkan jumlah takaran yang akan ditetapkan:", "Set", "Batal");
...
FUNC::AmbilCoran(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 4)
    {
		...
		for(new i; i < 4; i++)
		{
			PlayerTextDrawShow(playerid, jobs::PBMixer[playerid][i]);
        }
        ...
        ShowPlayerFooter(playerid, "~w~Antarkan ~g~beton ~w~ke lokasi proyek yang di ~r~tandai ~w~pada minimap anda~n~dan jaga ~w~kualitas ~y~slump ~w~agar tidak kering", 5000);
    }
    else
    {
...
jobs_mixer_label()
{
    ...
    CreateDynamic3DTextLabel(""LIGHT_GREEN"[ALT] {FFFFFF}mulai pekjerjaan supir mixer", X11_PINK, 641.2187,1238.3390,11.6796, 15.0);
...
FUNC::CorLokasi(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 15)
    {
        ...
        {
            ShowTDN(playerid, NOTIFICATION_ERROR, "Anda gagal menjaga kualitas slump beton!");
