...
{
    ToggleElectric = 0;
    //CreateDynamicPickup(1210, 23, -2524.6223,-621.2274,132.7295, 0, 0, -1, 50.0, -1, 0);
    CreateDynamic3DTextLabel(""LIGHTGREY"\n"GREEN"[ALT]"WHITE"", -1, -2524.6223,-621.2274,132.7295 + 0.5, 50.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1, 0, 0, -1, 50.0, -1, 0);
    return 1;
}
...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    ...
    {
        if(IsPlayerInRangeOfPoint(playerid, 3.5, -2524.6223,-621.2274,132.7295))
        {
            ShowElectricianJobTD(playerid);
        }
    }
    return 1;
}
...
hook OnPlayerEnterDynamicCP(playerid, STREAMER_TAG_CP:checkpointid)
{
    if(IsElectricanWorking(playerid) && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT && GetPVarInt(playerid, "IsPlayerHaveKit") == 1)
    {
        ...
        {
            Dialog_Show(playerid, FixElectric1, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        ...
        {
            Dialog_Show(playerid, FixElectric2, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric3, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric4, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric5, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric6, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric7, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric8, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric9, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric10, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric11, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric12, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric13, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric14, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric15, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric16, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric17, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric18, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric19, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric20, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric21, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric22, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric23, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric24, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric25, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric26, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric27, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
            \n\n"RED"[KUNING] "GREEN"[BIRU]" ""PURPLE"[MERAH]\
            \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
        }
        ...
        {
            Dialog_Show(playerid, FixElectric28, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric29, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        ...
        {
            Dialog_Show(playerid, FixElectric30, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
            "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
...
Dialog:ElectricanMenu(playerid, response, listitem, inputtext[])
{
    if(response)
    {
        ...
        switch(listitem)
        {
            ...
            {
                Dialog_Show(playerid, ElectricanInputGroup, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Create Group",
                "Harap masukkan nama group anda dibawah sini:", "Input", "Cancel");
            }
            case 1: // Invite orang
            {
                Dialog_Show(playerid, ElectricInvite, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Create Group",
                "Harap masukkan player id yang ingin kamu undang ke group:", "Invite", "Cancel");
            }
            case 2: // Kick Group Member
            {
                Dialog_Show(playerid, ElectricKick, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Create Group",
                "Harap masukkan player id yang ingin kamu kick dari group anda:", "Invite", "Cancel");
            }
            case 3: // Join Group Member
            {
                Dialog_Show(playerid, ElectricJoinGroup, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Create Group",
...
Dialog:ElectricJoinGroup(playerid, response, listitem, inputtext[])
{
    ...
    if(isnull(inputtext)) return Dialog_Show(playerid, ElectricJoinGroup, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Create Group",
    "Error: Tidak dapat diisi kosong!\nHarap masukkan group id job yang ingin anda ikuti:", "Invite", "Cancel");

    if(!IsNumeric(inputtext)) return Dialog_Show(playerid, ElectricJoinGroup, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Create Group",
...
Dialog:ElectricKick(playerid, response, listitem, inputtext[])
{
    ...
    if(isnull(inputtext)) return Dialog_Show(playerid, ElectricKick, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Create Group",
    "Error: Tidak dapat diisi kosong!\nHarap masukkan player id yang ingin kamu kick dari group anda:", "Invite", "Cancel");

    if(!IsNumeric(inputtext)) return Dialog_Show(playerid, ElectricKick, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Create Group",
    "Error: Hanya dapat diisi angka!\nHarap masukkan player id yang ingin kamu kick dari group anda:", "Invite", "Cancel");    

    new otherid = strval(inputtext);

    if(PlayerElectricJob[otherid][ElectricWithPlayerID] != playerid) return Dialog_Show(playerid, ElectricKick, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Create Group",
...
Dialog:ElectricanInputGroup(playerid, response, listitem, inputtext[])
{
    ...
    if(isnull(inputtext)) return Dialog_Show(playerid, ElectricanInputGroup, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Create Group",
    "Error: Tidak dapat diisi kosong!\nHarap masukkan nama group anda dibawah sini:", "Input", "Cancel");

    if(IsNumeric(inputtext)) return Dialog_Show(playerid, ElectricanInputGroup, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Create Group",
    "Error: Tidak dapat diisi angka!\nHarap masukkan nama group anda dibawah sini:", "Input", "Cancel");

    if(strlen(inputtext) < 7) return Dialog_Show(playerid, ElectricanInputGroup, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Create Group",
...
Dialog:ElectricInvite(playerid, response, listitem, inputtext[])
{
    ...
    if(isnull(inputtext)) return Dialog_Show(playerid, ElectricInvite, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Invite Group",
    "Error: Tidak dapat diisi kosong!\nHarap masukkan player id yang ingin kamu undang ke group:", "Input", "Cancel");

    if(!IsNumeric(inputtext)) return Dialog_Show(playerid, ElectricInvite, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Invite Group",
    "Error: Hanya dapat memasukkan angka!\nHarap masukkan player id yang ingin kamu undang ke group:", "Input", "Cancel");

    if(strval(inputtext) == INVALID_PLAYER_ID || !IsPlayerConnected(strval(inputtext))) return Dialog_Show(playerid, ElectricInvite, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Invite Group",
    "Error: Pemain yang anda undang tidak berada di dalam server!\nHarap masukkan player id yang ingin kamu undang ke group:", "Input", "Cancel");

    new otherid = strval(inputtext);

    if(!IsPlayerNearPlayer(playerid, otherid, 5.0)) return Dialog_Show(playerid, ElectricInvite, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Invite Group",
...
Dialog:FixElectric1(playerid, response, listitem, inputtext[])
{
    ...
    {
        return Dialog_Show(playerid, FixElectric1, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"RED"[KUNING] "GREEN"[BIRU]", ""WHITE"[MERAH]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
    ...
    if(!strcmp(color1, truecolor1, true) && !strcmp(color2, truecolor2, true) && !strcmp(color3, truecolor3, true))
    {
        if(PlayerElectricJob[playerid][ElectricWithPlayerID] == INVALID_PLAYER_ID)
        {
            ...
            ShowItemBox(playerid, "Uang", "Received_$63", 2);
        }
        else 
        {
            ApplyAnimationEx(playerid, "BD_FIRE", "wash_up", 4.1, 0, 0, 0, 0, 5000, 1);
            ...
            ShowItemBox(playerid, "Uang", "Received_$83", 2);
        }
...
Dialog:FixElectric2(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric2, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"GREEN"[MERAH] "YELLOW"[HIJAU]" ""RED"[UNGU]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric3(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric3, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"PURPLE"[ABU] "RED"[KUNING]" ""YELLOW"[UNGU]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric4(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric4, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"RED"[HIJAU] "YELLOW"[UNGU]" ""GREEN"[MERAH]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric5(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric5, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"YELLOW"[KUNING] "PURPLE"[UNGU]" ""RED"[KUNING]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric6(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric6, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"PURPLE"[KUNING] "PURPLE"[BIRU]" ""RED"[HIJAU]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric7(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric7, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"RED"[KUNING] "BLACK"[BIRU]" ""GREEN"[MERAH]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric8(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric8, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"BLUE"[HIJAU] "PURPLE"[KUNING]" ""GREEN"[MERAH]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric9(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric9, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"BLUE"[KUNING] "RED"[UNGU]" ""GREEN"[MERAH]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric10(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric10, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"RED"[KUNING] "GREEN"[BIRU]" ""PURPLE"[MERAH]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric11(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric11, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"YELLOW"[UNGU] "YELLOW"[BIRU]" ""RED"[ORANGE]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric12(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric12, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"LIGHTGREY"[ABU] "GREEN"[BIRU]" ""RED"[YELLOW]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric13(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric13, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"ORANGE"[MERAH] "GREEN"[OREN]" ""PURPLE"[ABU]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric14(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric14, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"WHITE"[KUNING] "BLUE"[HIJAU]" ""YELLOW"[MERAH]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric15(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric15, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"ORANGE"[OREN] "RED"[BIRU]" ""YELLOW"[MERAH]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric16(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric16, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"RED"[KUNING] "BLUE"[HIJAU]" ""GREEN"[OREN]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric17(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric17, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"RED"[KUNING] "LIGHTGREY"[UNGU]" ""PURPLE"[HIJAU]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric18(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric18, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"BLUE"[OREN] "RED"[BIRU]" ""YELLOW"[MERAH]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric19(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric19, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"PURPLE"[HIJAU] "RED"[KUNING]" ""PURPLE"[MERAH]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric20(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric20, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"RED"[KUNING] "RED"[BIRU]" ""PURPLE"[OREN]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric21(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric21, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"YELLOW"[UNGU] "RED"[OREN]" ""ORANGE"[HITAM]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric22(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric22, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"GREEN"[PUTIH] "GREEN"[UNGU]" ""ORANGE"[OREN]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric23(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric23, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"WHITE"[PUTIH] "YELLOW"[BIRU]" ""RED"[KUNING]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric24(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric24, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"ORANGE"[OREN] "RED"[MERAH]" ""GREEN"[KUNING]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric25(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric25, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"BLUE"[KUNING] "ORANGE"[BIRU]" ""PURPLE"[HITAM]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric26(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric26, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"YELLOW"[KUNING] "PURPLE"[MERAH]" ""LIGHTGREY"[ABU]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric27(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric27, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"RED"[KUNING] "GREEN"[BIRU]" ""PURPLE"[MERAH]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric28(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric28, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"PURPLE"[KUNING] "YELLOW"[BIRU]" ""BLUE"[MERAH]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric29(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric29, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"GREEN"[KUNING] "WHITE"[BIRU]" ""ORANGE"[MERAH]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
Dialog:FixElectric30(playerid, response, listitem, inputtext[])
{
    ...
    if(sscanf(inputtext, "s[64]s[64]s[64]", color1, color2, color3))
    {
        return Dialog_Show(playerid, FixElectric30, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Fix Kelistrikan",
        "harap berikan nama warna dalam bahasa indonesia yang sesuai dengan warna di sekitar teks di bawah ini\
        \n\n"YELLOW"[KUNING] "YELLOW"[BIRU]" ""PURPLE"[MERAH]\
        \n"RED"(Harap berikan nama warna saja berdasarkan warna teks di atas tanpa '[' atau ']')", "Input", "Cancel");
    }
...
// Function to show electrician job TextDraws
ShowElectricianJobTD(playerid)
{
    // Get player's current position for smooth camera transition
    new Float:playerX, Float:playerY, Float:playerZ, Float:playerAngle;
    GetPlayerPos(playerid, playerX, playerY, playerZ);
    GetPlayerFacingAngle(playerid, playerAngle);
    
    // Store player's position and state
    SetPVarFloat(playerid, "ElectricLastX", playerX);
    SetPVarFloat(playerid, "ElectricLastY", playerY);
    SetPVarFloat(playerid, "ElectricLastZ", playerZ);
    SetPVarFloat(playerid, "ElectricLastAngle", playerAngle);
    SetPVarInt(playerid, "ElectricSpectating", 1);
    
    // Enable spectating first
    TogglePlayerSpectating(playerid, true);
    
    // Start from player's view and smoothly move to NPC
    SetPlayerCameraPos(playerid, playerX, playerY, playerZ + 1.0);
    SetPlayerCameraLookAt(playerid, playerX + (5.0 * floatsin(-playerAngle, degrees)), 
                                   playerY + (5.0 * floatcos(-playerAngle, degrees)), 
                                   playerZ);
    
    // Smooth transition to NPC view
    InterpolateCameraPos(playerid,
        playerX, playerY, playerZ + 1.0, // Start from player's position
        -2527.4172, -624.2214, 134.7295, // Move to behind NPC
        2000, // 2 seconds transition
        CAMERA_MOVE
    );
    
    InterpolateCameraLookAt(playerid,
        playerX + (5.0 * floatsin(-playerAngle, degrees)), 
        playerY + (5.0 * floatcos(-playerAngle, degrees)), 
        playerZ, // Start looking where player was looking
        -2524.6223, -621.2274, 132.7295, // End looking at NPC
        2000, // 2 seconds transition
        CAMERA_MOVE
    );
    
    // First show all non-button TextDraws
    for(new i = 1; i <= 22; i++)
    {
        PlayerTextDrawShow(playerid, KerjaInfo[playerid][i]);
    }
    
    // Then show and make buttons selectable
    PlayerTextDrawSetSelectable(playerid, KerjaInfo[playerid][23], true);
    PlayerTextDrawSetSelectable(playerid, KerjaInfo[playerid][24], true);
    PlayerTextDrawShow(playerid, KerjaInfo[playerid][23]);
    PlayerTextDrawShow(playerid, KerjaInfo[playerid][24]);
    
    // Show remaining TextDraws
    for(new i = 25; i <= 30; i++)
    {
        PlayerTextDrawShow(playerid, KerjaInfo[playerid][i]);
    }
    
    // Enable TextDraw selection mode last
    SelectTextDraw(playerid, 0x3b4c595e);
    
    // Move to side view after initial transition
    SetTimerEx("MoveCameraToSide", 2100, false, "i", playerid);
}

// Function to move camera to side view
forward MoveCameraToSide(playerid);
public MoveCameraToSide(playerid)
{
    if(!GetPVarInt(playerid, "ElectricSpectating")) return 0;
    
    InterpolateCameraPos(playerid,
        -2527.4172, -624.2214, 134.7295, // From behind NPC
        -2524.6223, -618.2274, 133.7295, // To front-right of NPC's face (moved more right)
        1500,
        CAMERA_MOVE
    );
    
    InterpolateCameraLookAt(playerid,
        -2524.6223, -621.2274, 132.7295, // From looking at NPC
        -2524.6223, -621.2274, 133.1295, // To looking at NPC's face
        1500,
        CAMERA_MOVE
    );
    return 1;
...
// Function to hide electrician job TextDraws
HideElectricianJobTD(playerid)
{
    ...
    new Float:lastX = GetPVarFloat(playerid, "ElectricLastX");
    new Float:lastY = GetPVarFloat(playerid, "ElectricLastY");
    new Float:lastZ = GetPVarFloat(playerid, "ElectricLastZ");
    new Float:lastAngle = GetPVarFloat(playerid, "ElectricLastAngle");
    
    // Disable spectating immediately
    TogglePlayerSpectating(playerid, false);
    
    // Reset player position
    SetPlayerPos(playerid, lastX, lastY, lastZ);
    SetPlayerFacingAngle(playerid, lastAngle);
    SetCameraBehindPlayer(playerid);
    
    // Clear spectating state
    DeletePVar(playerid, "ElectricSpectating");
    DeletePVar(playerid, "ElectricLastX");
    DeletePVar(playerid, "ElectricLastY");
    DeletePVar(playerid, "ElectricLastZ");
    DeletePVar(playerid, "ElectricLastAngle");
    
    // Hide all TextDraws
    CancelSelectTextDraw(playerid);
    for(new i = 1; i <= 30; i++)
    {
        PlayerTextDrawHide(playerid, KerjaInfo[playerid][i]);
    }
    return 1;
}