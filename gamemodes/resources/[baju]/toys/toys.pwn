...
{
	new cQuery[2048];
	mysql_format(dcrp_query, cQuery, sizeof(cQuery), "UPDATE `toys` SET `Slot0_Model`=%d, `Slot0_Bone`=%d, `Slot0_Status`=%d, `Slot0_XPos`=%f, `Slot0_YPos`=%f, `Slot0_ZPos`=%f, `Slot0_XRot`=%f, `Slot0_YRot`=%f, `Slot0_ZRot`=%f, `Slot0_XScale`=%f, `Slot0_YScale`=%f, `Slot0_ZScale`=%f,\
