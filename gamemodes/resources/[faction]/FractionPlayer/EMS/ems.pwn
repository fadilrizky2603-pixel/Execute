...
VarsDoorEms()
{
    EMSStuff[EMSDuty] = CreateDynamicSphere(1317.9290,744.0595,10.8784, 2.0, -1, -1, -1);
    EMSStuff[EMSGarage] = CreateDynamicSphere(1360.2725,755.4210,10.8203, 2.0, -1, -1, -1);			
    EMSStuff[EMSBrankas] = CreateDynamicSphere(1315.3718,739.1440,10.8784, 2.0, -1, -1, -1);
    EMSStuff[EMSLocker] = CreateDynamicSphere(1307.7452,745.4649,10.8714, 2.0, -1, -1, -1);
    EMSStuff[EMSDesk] = CreateDynamicSphere(1333.8000,765.8342,10.8744, 2.0, -1, -1, -1);
    EMSStuff[EMSItemsLocker] = CreateDynamicSphere(1309.4424,742.6887,10.8714, 2.0, -1, -1, -1);
    EMSStuff[EMSHeli] = CreateDynamicSphere(2065.6079, -1431.7476, 48.3359, 2.0, -1, -1, -1);
    EMSStuff[EMSGaragePOS][0] = 1360.2725;
    EMSStuff[EMSGaragePOS][1] = 755.4210;
    EMSStuff[EMSGaragePOS][2] = 10.8203;
    
    EMSStuff[EMSSpawnPOS][0] = 1365.8774;
    EMSStuff[EMSSpawnPOS][1] = 775.3719;
    EMSStuff[EMSSpawnPOS][2] = 10.8203;
    EMSStuff[EMSSpawnPOS][3] = 105.5341;
}
...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(newkeys & KEY_WALK && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        if(AccountData[playerid][pFaction] == FACTION_EMS)
        {
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_EMS_LOCKER, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Locker EMS",
            ...
            if(IsPlayerInDynamicArea(playerid, EMSStuff[EMSDesk]) && AccountData[playerid][pDutyEms])
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_EMS_BOSDESK, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Bos Desk",
                "Invite\
                \n"GRAY"Kelola Jabatan\
                \nKick\
                \n"GRAY"Lihat Anggota\
            ...
            if(IsPlayerInDynamicArea(playerid, EMSStuff[EMSHeli]) && AccountData[playerid][pDutyEms])
            {
                ...
                if(!EMSSpawnHeli[playerid])
                {
                    EMSHeliVeh[playerid] = AddStaticVehicleEx(487, 2080.3137, -1424.0839, 51.3115, 358.8177, 3, 1, 60000, 1);
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_EMS_GARAGE, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Garasi EMS",
                "Keluarkan Kendaraan\
            ...
            if(IsPlayerInDynamicArea(playerid, EMSStuff[EMSBrankas]) && AccountData[playerid][pDutyEms])
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_EMSVAULT, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Brankas EMS",
            ...
            if(IsPlayerInDynamicArea(playerid, EMSStuff[EMSItemsLocker]) && AccountData[playerid][pDutyEms])
            {
                ...
                new sstr[512];
                format(sstr, sizeof sstr, "Item\tStok\n");
                format(sstr, sizeof sstr, "%sPerban\t%d\n", sstr, Bandage);
                format(sstr, sizeof sstr, "%sMedkit\t%d\n", sstr, Medkit);
                format(sstr, sizeof sstr, "%sAlprazolam\t%d\n", sstr, PillStress);
                Dialog_Show(playerid, Brankas_Ems, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Brankas Ems", sstr, "Pilih", "Batal");
            }
        }
    }
    return 1;
...
hook OnPlayerEnterDynArea(playerid, STREAMER_TAG_AREA:areaid)
{
    if(AccountData[playerid][pFaction] == FACTION_EMS)
    {
        ...
        if(areaid == EMSStuff[EMSHeli] && AccountData[playerid][pDutyEms])
        {
            if(!EMSSpawnHeli[playerid])
            {
                ShowKey(playerid, "Spawn Heli");               
            }
            else 
            {
                ShowKey(playerid, "Kembalikan Heli");
            }
        }

        if(areaid == EMSStuff[EMSItemsLocker] && AccountData[playerid][pDutyEms])
        {
            ShowKey(playerid, "Store EMS");
        }
    }
    return 1;
}
...
Dialog:Brankas_Ems(playerid, response, listitem, inputtext[])
{
    if(response)
    {
        switch(listitem)
        {
            case 0:
            {
                Dialog_Show(playerid, Perban_Ems, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas EMS", "Mohon ikuti sesuai format berikut:\n[ambil] [jumlah] atau [depo] [jumlah]\nMohon masukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 1:
            {
                Dialog_Show(playerid, Medkit_Ems, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas EMS", "Mohon ikuti sesuai format berikut:\n[ambil] [jumlah] atau [depo] [jumlah]\nMohon masukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
            case 2:
            {
                Dialog_Show(playerid, Pill_Ems, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas EMS", "Mohon ikuti sesuai format berikut:\n[ambil] [jumlah] atau [depo] [jumlah]\nMohon masukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
            }
        }
    }
...
Dialog:Pill_Ems(playerid, response, listitem, inputtext[])
{
    if(response)
    {
        ...
        if(!strcmp(option, "ambil", true))
        {
            ...
            PillStress -= amount;
            ItemAdd(playerid, "Alprazolam", amount);
            ShowTDN(playerid, NOTIFICATION_SUKSES, "Anda berhasil mengambil Alprazolam");
            BrankasEms_Save();

            static frmtx[255];
            format(frmtx, sizeof(frmtx), "EMS - Mengambil Alprazolam sejumlah %d dari dalam Apotik", amount);
        ...
        if(!strcmp(option, "depo", true))
        {
            ...
            PillStress += amount;
            ItemDelete(playerid, "Alprazolam", amount);
...
Dialog:Medkit_Ems(playerid, response, listitem, inputtext[])
{
    if(response)
    {
        ...
        if(!strcmp(option, "ambil", true))
        {
            ...
            Medkit -= amount;
            ItemAdd(playerid, "Medkit", amount);
            ShowTDN(playerid, NOTIFICATION_SUKSES, "Anda berhasil mengambil medkit");
            BrankasEms_Save();

            static frmtx[255];
            format(frmtx, sizeof(frmtx), "EMS - Mengambil Medkit sejumlah %d dari dalam Apotik", amount);
            AddFMoneyLog(AccountData[playerid][pName], AccountData[playerid][pUCP], amount, frmtx);
        }
        ...
        if(!strcmp(option, "depo", true))
        {
            ...
            Medkit += amount;
            ItemDelete(playerid, "Medkit", amount);
...
Dialog:Perban_Ems(playerid, response, listitem, inputtext[])
{
    if(response)
    {
        ...
        if(!strcmp(option, "ambil", true))
        {
            ...
            Bandage -= amount;
            ItemAdd(playerid, "Bandage", amount);
            ShowTDN(playerid, NOTIFICATION_SUKSES, "Anda berhasil mengambil perban");
            BrankasEms_Save();

            static frmtx[255];
            format(frmtx, sizeof(frmtx), "EMS - Mengambil Bandage sejumlah %d dari dalam Apotik", amount);
            AddFMoneyLog(AccountData[playerid][pName], AccountData[playerid][pUCP], amount, frmtx);
        }
        ...
        if(!strcmp(option, "depo", true))
        {
            ...
            Bandage += amount;
            ItemDelete(playerid, "Bandage", amount);
    ...
    switch(dialogid)
    {
        case DIALOG_EMSBRANKAS:
        {
            ...
            switch(listitem)
            {
                case 0:// perban
                {
                    ShowPlayerDialog(playerid, DIALOG_EMSBKCONFIRM, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas EMS",
                    ""WHITE"Anda akan membuat Perban dengan:\
                    \n\nBahan yang dibutuhkan:\
                    \nKain: 50x\
                    \nPure Oil: 25x\
                    \nPlastik: 150x\
                    \nKaret: 25x\
                    \n\n"YELLOW"( Masukkan berapa jumlah yang ingin anda buat! )", "Input", "Batal");
                }
                case 1:// medkit 
                {
                    ShowPlayerDialog(playerid, DIALOG_EMSBKCONFIRM, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas EMS",
                    ""WHITE"Anda akan membuat Medkit dengan:\
                    \n\nBahan yang dibutuhkan:\
                    \nKain: 20x\
                    \nPure Oil: 10x\
                    \nPlastik: 15x\
                ...
                {
                    ShowPlayerDialog(playerid, DIALOG_EMSBKCONFIRM, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas EMS",
                    ""WHITE"Anda akan membuat Alprazolam dengan:\
                    \n\nBahan yang dibutuhkan:\
                    \nKain: 5x\
                    \nPure Oil: 6x\
                    \nPlastik: 7x\
        ...
        case DIALOG_EMSBKCONFIRM:
        {
            ...
            if(AccountData[playerid][pFaction] != FACTION_EMS) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota EMS DCRP!");
            if(isnull(inputtext)) return ShowPlayerDialog(playerid, DIALOG_EMSBKCONFIRM, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas EMS",
            "Error: Tidak dapat dikosongkan!\
            \n( Masukkan berapa jumlah yang ingin anda beli! )", "Input", "Batal");
            if(!IsNumeric(inputtext)) return ShowPlayerDialog(playerid, DIALOG_EMSBKCONFIRM, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas EMS",
            ...
            switch(AccountData[playerid][pTempSQLFactMemberID])
            {
                case 0:// perban
                {
                    ...
                    ItemDelete(playerid, "Kain", bahan1);
                    ItemDelete(playerid, "Pure Oil", bahan2);
                    ItemDelete(playerid, "Plastik", bahan3);
                    ItemDelete(playerid, "Karet", bahan4);
                    ItemAdd(playerid, "Bandage", value);
                    ShowItemBox(playerid, "Bandage", sprintf("Recieved_%dx", value), 2);
                    ShowTDN(playerid, NOTIFICATION_SUKSES, "Anda berhasil mengambil perban!");
                }
                case 1://medkit 
                {
                    ...
                    ItemDelete(playerid, "Plastik", bahan3);
                    ItemDelete(playerid, "Karet", bahan4);
                    ItemAdd(playerid, "Medkit", value);
                    ShowItemBox(playerid, "Medkit", sprintf("Recieved_%dx", value), 2);
                    ShowTDN(playerid, NOTIFICATION_SUKSES, "Anda berhasil mengambil medkit!");
                }
                case 2:// Alprazolam
                {
                    ...
                    ItemDelete(playerid, "Plastik", bahan3);
                    ItemDelete(playerid, "Karet", bahan4);
                    ItemAdd(playerid, "Alprazolam", value);
                    ShowItemBox(playerid, "Alprazolam", sprintf("Recieved_%dx", value), 2);
                    ShowTDN(playerid, NOTIFICATION_SUKSES, "Anda berhasil mengambil Alprazolam!");
                }
            }
        ...
        case DIALOG_EMS_GARAGE:
        {
            ...
            switch(listitem)
            {
                case 0: //takeout
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_EMS_GARAGE_TAKEOUT, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Garasi EMS", lstr, "Pilih", "Batal");
                }
                case 1:// Simpan KendaraanA
                {
                    ...
                    if(!foundnearby) return ShowTDN(playerid, NOTIFICATION_ERROR, "Tidak ada kendaraan dari EMS DCRP milik anda di sekitar!");
                }
                case 2:// Beli Kendaraan
                {
                    ShowPlayerDialog(playerid, DIALOG_EMS_GARAGE_BUY, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Garasi EMS",
                    "Model\tHarga\
                    \nAmbulance\t$5000\
                ...
                {
                    new frmtdel[158];
                    mysql_format(dcrp_query, frmtdel, sizeof(frmtdel), "SELECT * FROM `player_vehicles` WHERE `PVeh_Faction` = 3 AND `PVeh_OwnerID` = %d", AccountData[playerid][pID]);
                    ...
                    if(rowscount)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_EMS_GARAGE_DELETE, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Hapus Kendaraan", list, "Hapus", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Hapus Kendaraan", "Anda tidak memiliki kendaraan EMS.", "Tutp", "");
                    }
                }
            }
        }
        ...
        case DIALOG_EMS_PANEL:
        {
            ...
            switch(listitem)
            {
                ...
                {   
                    ...
                    PlayerTextDrawSetString(targetid, ProgressBar[targetid][2], "TREATMENT");
            ...
            switch(listitem)
            {
                case 0: //deposit
                {
                    ...
                    if(rows) 
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_EMSVAULT_DEPOSIT, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Brankas EMS", str, "Pilih", "Batal");
                    }
                    else 
                    {
                        AccountData[playerid][menuShowed] = false;
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Brankas EMS",
                ...
                case 1: //withdraw
                {
                    ...
                    format(str, sizeof(str), "Nama Item\tJumlah\tBerat (-/-)\n");
                    mysql_query(dcrp_query, "SELECT * FROM `ems_brankas` WHERE `PID`=0");
                    if(cache_num_rows() > 0)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_EMSVAULT_WITHDRAW, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Brankas EMS", str, "Pilih", "Batal");
                    }
                    else 
                    {
                        AccountData[playerid][menuShowed] = false;
        ...
        case DIALOG_EMSVAULT_DEPOSIT:
        {
            ...
            if(cache_num_rows() > 0)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_EMSVAULT_IN, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas EMS", 
                shstr, "Input", "Batal");
            }
        }
        case DIALOG_EMSVAULT_IN:
        {
            ...
            new invstr[1028];
            mysql_format(dcrp_query, shstr, sizeof(shstr), "SELECT * FROM `ems_brankas` WHERE `PID`=0 AND `Item` = '%s'", FactionBrankas[playerid][factionBrankasTemp]);
            mysql_query(dcrp_query, shstr);
            new rows = cache_num_rows();
            if(rows > 0)
            {
                mysql_format(dcrp_query, invstr, sizeof(invstr), "UPDATE `ems_brankas` SET `Quantity` = `Quantity` + %d WHERE `PID` = 0 AND `Item`='%s'", quantity, FactionBrankas[playerid][factionBrankasTemp]);
                mysql_tquery(dcrp_query, invstr, "OnEMSDeposit", "i", playerid);
            }
            else 
            {
                mysql_format(dcrp_query, invstr, sizeof(invstr), "INSERT INTO `ems_brankas` SET `PID`=0, `Item`='%s', `Model`=%d, `Quantity`=%d", FactionBrankas[playerid][factionBrankasTemp], FactionBrankas[playerid][factionBrankasModel], quantity);
                mysql_tquery(dcrp_query, invstr, "OnEMSDeposit", "i", playerid);
            }
            AccountData[playerid][menuShowed] = false;
        }
        case DIALOG_EMSVAULT_WITHDRAW:
        {
            ...
            if(cache_num_rows() > 0)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_EMSVAULT_OUT, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas EMS",
                shstr, "Input", "Batal");
            }
            else 
            {
                AccountData[playerid][menuShowed] = false;
                ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Brankas EMS",
        ...
        case DIALOG_EMSVAULT_OUT:
        {
            ...
            {
                mysql_format(dcrp_query, jts, sizeof(jts), "UPDATE `ems_brankas` SET `Quantity`=%d WHERE `ID`=%d", FactionBrankas[playerid][factionBrankasQuant], FactionBrankas[playerid][factionBrankasID]);
                mysql_tquery(dcrp_query, jts);
            }
            else 
            {
                mysql_format(dcrp_query, jts, sizeof(jts), "DELETE FROM `ems_brankas` WHERE `ID`=%d", FactionBrankas[playerid][factionBrankasID]);
                mysql_tquery(dcrp_query, jts);
            }
        ...
        {
            if(!response) return ShowTDN(playerid, NOTIFICATION_INFO, "Anda telah membatalkan pilihan");
            if(AccountData[playerid][pFaction] != FACTION_EMS) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari EMS DCRP!");
        ...
        case DIALOG_EMS_BOSDESK:
        {
            ...
            switch(listitem)
            {
                case 0: //invite
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_EMS_INVITE, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Invite", frmxt, "Pilih", "Batal");
                }
                case 1:// Kelola Jabatan
                {
                    mysql_query(dcrp_query, "SELECT * FROM player_characters WHERE Char_Faction = 3 ORDER BY Char_FactionRank DESC");
                    ...
                    if(rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_EMSSETRANK, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Set Jabatan", shstr, "Pilih", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Set Jabatan", "Tidak ada Anggota EMS!", "Tutup", "");
                    }
                }
                case 2:// Kick Offline / Online
                {
                    ...
                    if(rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_EMSKICKMEMBER, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Kick Anggota", shstr, "Kick", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Kick Anggota", "Tidak ada Anggota EMS!", "Tutup", "");
                    }
                }
                ...
                {
                    new frmxt[158];
                    format(frmxt, sizeof(frmxt), "Perusahaan EMS DCRP saat ini memiliki saldo sebesar:\ 
                    \n"DARKGREEN"%s", FormatMoney(EMSMoneyVault));
                    ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- EMS Money", frmxt, "Tutup", "");
                }
                case 5:// Deposit saldo
                {
                    ShowPlayerDialog(playerid, DIALOG_DEPOSIT_EMS, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- EMS Deposit", 
                    "Mohon masukkan nominal deposit untuk saldo perusahaan:", "Input", "Batal");
                }
                case 6://
                {
                    ShowPlayerDialog(playerid, DIALOG_WITHDRAW_EMS, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- EMS Withdraw", 
        ...
        case DIALOG_DEPOSIT_EMS:
        {
            ...
            mysql_format(dcrp_query, frmtmny, sizeof(frmtmny), "UPDATE `stuffs` SET `emsmoneyvault` = %d WHERE `ID` = 0", EMSMoneyVault);
            mysql_tquery(dcrp_query, frmtmny);
            ShowTDN(playerid, NOTIFICATION_SUKSES, sprintf("Anda berhasil deposit %s untuk EMS DCRP", FormatMoney(depocash)));
        ...
        case DIALOG_WITHDRAW_EMS:
        {
            ...
            ShowTDN(playerid, NOTIFICATION_SUKSES, sprintf("Anda berhasil withdraw %s dari EMS DCRP", FormatMoney(withdrawcash)));
        ...
        case DIALOG_EMSKICKMEMBER:
        {
            ...
            if(cache_num_rows())
            {
                ...
                new strgbg[158];
                mysql_format(dcrp_query, strgbg, sizeof(strgbg), "DELETE FROM `player_vehicles` WHERE `PVeh_OwnerID`=%d AND `PVeh_Faction` = 3", pidrow);
                mysql_tquery(dcrp_query, strgbg);
                ...
                foreach(new i : Player)
                {
                    if(AccountData[i][IsLoggedIn] && AccountData[i][pSpawned] && pidrow == AccountData[i][pID])
                    {
                        ...
                        ShowTDN(i, NOTIFICATION_WARNING, "Anda telah dikeluarkan dari faction EMS DCRP!");
                    }
                }
        ...
        case DIALOG_EMSSETRANK:
        {
            ...
            if(rows)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_RANK_SET_EMS, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Kelola Jabatan", \
        ...
        case DIALOG_RANK_SET_EMS:
        {
            ...
            if(isnull(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_EMS, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Kelola Jabatan", \
            ...
            if(!IsNumeric(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_EMS, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Kelola Jabatan", \
            "Error: Hanya dapat diisi angka!\n\
            Silahkan pilih jabatan untuk ditetapkan (masukkan angka saja):\n\
            1. Training\n\
            2. Perawat\n\
            ...
            if(strval(inputtext) < 1 || strval(inputtext) > AccountData[playerid][pFactionRank]) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_EMS, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Kelola Jabatan", \
        ...
        case DIALOG_EMS_INVITE:
        {
            ...
            mysql_format(dcrp_query, icsr, sizeof(icsr), "UPDATE `player_characters` SET `Char_Faction` = 3, `Char_FactionRank` = 1 WHERE `pID` = %d", AccountData[targetid][pID]);
            mysql_tquery(dcrp_query, icsr);
        ...
        case DIALOG_EMS_LOCKER:
        {
            ...
            switch(listitem)
            {
                ...
                case 1:
                {
                    ShowPlayerDialog(playerid, DIALOG_EMS_CLOTHES, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Lemari EMS", 
                    "Dokter 1\ 
                    \n"GRAY"Dokter 2\ 
                    \nDokter 3\ 
...
public EMSTreatment(playerid)
{
    ...
    else
    {
        ...
        progressvalue = AccountData[playerid][ActivityTime] * 67/20;
