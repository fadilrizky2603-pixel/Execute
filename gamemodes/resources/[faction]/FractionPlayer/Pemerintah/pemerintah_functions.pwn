...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(newkeys & KEY_WALK && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        if(AccountData[playerid][pFaction] == FACTION_PEMERINTAH)
        {
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_PEMERINTAH_LOCKER, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Locker Pemerintah", 
            ...
            if(IsPlayerInDynamicArea(playerid, PemerStuff[PemerDesk]) && AccountData[playerid][pDutyPemerintah])
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_PEMERINTAH_BOSDESK, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Bos Desk",
                "Invite\
                \n"GRAY"Kelola Jabatan\
                \nKick\
                \n"GRAY"Lihat Anggota\
            ...
            if(IsPlayerInDynamicArea(playerid, PemerStuff[PemerBrankas]) && AccountData[playerid][pDutyPemerintah])
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_PEMERVAULT, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Brankas Pemerintah",
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_PEMER_GARAGE, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Garasi Pemerintah", 
                "Keluarkan Kendaraan\
...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    ...
    switch(dialogid)
    {
        case DIALOG_PEMER_GARAGE:
        {
            ...
            if(AccountData[playerid][pFaction] != FACTION_PEMERINTAH) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Pemerintah Daerah Kota DCRP!");
            ...
            switch(listitem)
            {
                case 0:// Keluarkan kendaraan
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_PEMER_GARAGE_TAKEOUT, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Garasi Gojek", lstr, "Pilih", "Batal");
                }
                case 1://Simpan Kendaraan
                {
                    ...
                    if(!foundnearby) return ShowTDN(playerid, NOTIFICATION_ERROR, "Tidak ada kendaraan dari Pemerintah DCRP milik anda di sekitar!");
                }
                case 2://Beli Kendaraan
                {
                    ShowPlayerDialog(playerid, DIALOG_PEMER_GARAGE_BUY, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Beli Kendaraan",
                    "Model\tHarga\
                    \nStretch\t$8000\
                ...
                {
                    new frmtdel[158];
                    mysql_format(dcrp_query, frmtdel, sizeof(frmtdel), "SELECT * FROM `player_vehicles` WHERE `PVeh_Faction` = 2 AND `PVeh_OwnerID` = %d", AccountData[playerid][pID]);
                    ...
                    if(rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_PEMER_GARAGE_DELETE, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Hapus Kendaraan", list, "Hapus", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return Dialog_Show(playerid, ShowOnly, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Hapus Kendaraan", "Anda tidak memiliki kendaraan Pemerintah", "Tutup", "");
                    }
                }
            }
        }
        case DIALOG_PEMER_GARAGE_TAKEOUT:
        {
            ...
            if(AccountData[playerid][pFaction] != FACTION_PEMERINTAH) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota Pemerintah DCRP");
        ...
        {
            if(!response) return ShowTDN(playerid, NOTIFICATION_INFO, "Anda telah membatalkan pilihan");
            if(AccountData[playerid][pFaction] != FACTION_PEMERINTAH) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Pemerintah Daerah DCRP!");
        ...
        case DIALOG_PEMERVAULT:
        {
            ...
            {
                AccountData[playerid][menuShowed] = false;   
                return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota dari Pemerintah Daerah Kota DCRP!");
            }
            switch(listitem)
            {
                case 0: //deposit
                {
                    ...
                    if(rows) 
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_PEMERVAULT_DEPOSIT, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Brankas Pemerintah", str, "Pilih", "Batal");
                    }
                    else 
                    {
                        AccountData[playerid][menuShowed] = false;
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Brankas Pemerintah",
                ...
                case 1: //withdraw
                {
                    ...
                    format(str, sizeof(str), "Nama Item\tJumlah\tBerat (-/-)\n");
                    mysql_query(dcrp_query, "SELECT * FROM `pemerintah_brankas` WHERE `PID`=0");
                    if(cache_num_rows() > 0)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_PEMERVAULT_WITHDRAW, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Brankas Pemerintah", str, "Pilih", "Batal");
                    }
                    else 
                    {
                        AccountData[playerid][menuShowed] = false;
        ...
        case DIALOG_PEMERVAULT_DEPOSIT:
        {
            ...
            if(cache_num_rows() > 0)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_PEMERVAULT_IN, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas Pemerintah", 
                shstr, "Input", "Batal");
            }
        }
        case DIALOG_PEMERVAULT_IN:
        {
            ...
            new invstr[1028];
            mysql_format(dcrp_query, shstr, sizeof(shstr), "SELECT * FROM `pemerintah_brankas` WHERE `PID`=0 AND `Item` = '%s'", FactionBrankas[playerid][factionBrankasTemp]);
            mysql_query(dcrp_query, shstr);
            new rows = cache_num_rows();
            if(rows > 0)
            {
                mysql_format(dcrp_query, invstr, sizeof(invstr), "UPDATE `pemerintah_brankas` SET `Quantity` = `Quantity` + %d WHERE `PID` = 0 AND `Item`='%s'", quantity, FactionBrankas[playerid][factionBrankasTemp]);
                mysql_tquery(dcrp_query, invstr, "OnPemerintahDeposit", "i", playerid);
            }
            else 
            {
                mysql_format(dcrp_query, invstr, sizeof(invstr), "INSERT INTO `pemerintah_brankas` SET `PID`=0, `Item`='%s', `Model`=%d, `Quantity`=%d", FactionBrankas[playerid][factionBrankasTemp], FactionBrankas[playerid][factionBrankasModel], quantity);
                mysql_tquery(dcrp_query, invstr, "OnPemerintahDeposit", "i", playerid);
            }
            AccountData[playerid][menuShowed] = false;
        }
        case DIALOG_PEMERVAULT_WITHDRAW:
        {
            ...
            if(cache_num_rows() > 0)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_PEMERVAULT_OUT, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas Pemerintah",
                shstr, "Input", "Batal");
            }
            else 
            {
                AccountData[playerid][menuShowed] = false;
                ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Brankas Pemerintah",
        ...
        case DIALOG_PEMERVAULT_OUT:
        {
            ...
            {
                mysql_format(dcrp_query, jts, sizeof(jts), "UPDATE `pemerintah_brankas` SET `Quantity`=%d WHERE `ID`=%d", FactionBrankas[playerid][factionBrankasQuant], FactionBrankas[playerid][factionBrankasID]);
                mysql_tquery(dcrp_query, jts);
            }
            else 
            {
                mysql_format(dcrp_query, jts, sizeof(jts), "DELETE FROM `pemerintah_brankas` WHERE `ID`=%d", FactionBrankas[playerid][factionBrankasID]);
                mysql_tquery(dcrp_query, jts);
            }
        ...
        case DIALOG_PEMERINTAH_BOSDESK:
        {
            ...
            switch(listitem)
            {
                case 0: //invite
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_PEMERINTAH_INVITE, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Invite", frmxt, "Pilih", "Batal");
                }
                case 1:// Kelola Jabatan Offline / Online
                {
                    mysql_query(dcrp_query, "SELECT * FROM player_characters WHERE Char_Faction = 2 ORDER BY Char_FactionRank DESC");
                    ...
                    if(rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_PEMERSETRANK, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Set Jabatan", shstr, "Pilih", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Set Jabatan", "Tidak ada Anggota Pemerintah!", "Tutup", "");
                    }
                }
                case 2:// kick offline / online
                {
                    ...
                    if(rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_PEMERKICKMEMBER, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Kick Anggota", shstr, "Pilih", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Kick Anggota", "Tidak ada Anggota Pemerintahan!", "Tutup", "");
                    }
                }
                ...
                {
                    new frmxt[158];
                    format(frmxt, sizeof(frmxt), "Pemerintahan Daerah DCRP saat ini memiliki saldo sebesar:\ 
                    \n"DARKGREEN"%s", FormatMoney(PemerintahMoneyVault));
                    ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Pemerintah Money", frmxt, "Tutup", "");
                }
                case 5:// Deposit Uang
                {
                    ShowPlayerDialog(playerid, DIALOG_PEMERINTAH_DEPOSIT, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Pemerintah Deposit",
                    "Mohon masukkan nominal deposit untuk saldo finansial:", "Input", "Batal");
                }
                case 6: // Tarik Uang
                {
                    ShowPlayerDialog(playerid, DIALOG_PEMERINTAH_WITHDRAW, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Pemerintah Withdraw",
        ...
        case DIALOG_PEMERINTAH_DEPOSIT:
        {
            ...
            mysql_format(dcrp_query, frmtmny, sizeof(frmtmny), "UPDATE `stuffs` SET `pemerintahmoneyvault` = %d WHERE `ID` = 0", PemerintahMoneyVault);
            mysql_tquery(dcrp_query, frmtmny);
            ShowTDN(playerid, NOTIFICATION_SUKSES, sprintf("Anda berhasil deposit %s ke Pemerintah DCRP", FormatMoney(depocash)));
        } 
        case DIALOG_PEMERINTAH_WITHDRAW:
        {
            ...
            ShowTDN(playerid, NOTIFICATION_SUKSES, sprintf("Anda berhasil withdraw %s dari Pemerintah DCRP", FormatMoney(withdrawcash)));
        }
        case DIALOG_PEMERINTAH_INVITE:
        {
            ...
            mysql_format(dcrp_query, icsr, sizeof(icsr), "UPDATE `player_characters` SET `Char_Faction` = 2, `Char_FactionRank` = 1 WHERE `pID` = %d", AccountData[targetid][pID]);
        ...
        case DIALOG_PEMERKICKMEMBER:
        {
            ...
            if(cache_num_rows())
            {
                ...
                new strgbg[158];
                mysql_format(dcrp_query, strgbg, sizeof(strgbg), "DELETE FROM `player_vehicles` WHERE `PVeh_OwnerID`=%d AND `PVeh_Faction` = 2", pidrow);
                mysql_tquery(dcrp_query, strgbg);
                ...
                foreach(new i : Player)
                {
                    if(AccountData[i][IsLoggedIn] && AccountData[i][pSpawned] && pidrow == AccountData[i][pID])
                    {
                        ...
                        RefreshFactionMap(i);
                        ShowTDN(i, NOTIFICATION_WARNING, "Anda telah dikeluarkan dari faction Pemerintah DCRP!");
                    }
                }
        ...
        case DIALOG_PEMERSETRANK:
        {
            ...
            if(rows)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_RANK_SET_PEMERINTAH, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Kelola Jabatan", \
        ...
        case DIALOG_RANK_SET_PEMERINTAH:
        {
            ...
            if(isnull(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_PEMERINTAH, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Kelola Jabatan", \
            ...
            if(!IsNumeric(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_PEMERINTAH, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Kelola Jabatan", \
            ...
            if(strval(inputtext) < 1 || strval(inputtext) > AccountData[playerid][pFactionRank]) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_PEMERINTAH, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Kelola Jabatan", \
        ...
        case DIALOG_PEMERINTAH_PANEL:
        {
            ...
            if(AccountData[playerid][pFaction] != FACTION_PEMERINTAH) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Pemerintah Kota DCRP!");
            ...
            switch(listitem)
            {
                ...
                case 1:// Switch Pakaian
                {
                    if(AccountData[playerid][pGender] == 1) {
                        ShowPlayerDialog(playerid, DIALOG_PEMERINTAH_LOCKERMALE, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Baju Dinas", ""WHITE"Pemerintah 1\n"GRAY"Pemerintah 2\n"WHITE"Pemerintah 3", "Pilih", "Batal");
                    } else {
                        ShowPlayerDialog(playerid, DIALOG_PEMERINTAH_LOCKERFEMALE, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Baju Dinas", ""WHITE"Pemerintah 1\n"GRAY"Pemerintah 2", "Pilih", "Batal");
                    }
                }
            }
        }
...
CMD:ubahnamaktp(playerid, params[])
{
    ...
    new query[255];
    mysql_format(dcrp_query, query, sizeof(query), "SELECT `Char_Name` FROM `player_characters` WHERE `Char_Name`='%s'", tmp);
    mysql_tquery(dcrp_query, query, "OnChangeKtpName", "iis", otherid, playerid, tmp);
    return 1;
}
...
public OnChangeKtpName(otherPlayer, playerid, const name[])
{
    if(!cache_num_rows())
	{
		...
		mysql_format(dcrp_query, query, sizeof(query), "UPDATE `player_characters` SET `Char_Name`='%s' WHERE `pID`=%d", name, AccountData[otherPlayer][pID]);
		...
		{
			mysql_format(dcrp_query, query, sizeof(query), "UPDATE `families` SET `F_Leader`='%s' WHERE `F_Leader`='%s'", name, oldname);
			mysql_tquery(dcrp_query, query);
		}

		if(AccountData[playerid][PurchasedToy])
		{
			mysql_format(dcrp_query, query, sizeof(query), "UPDATE `toys` SET `Owner`='%s' WHERE `Owner`='%s'", name, oldname);
			mysql_tquery(dcrp_query, query);
		}
...
{
    if(AccountData[playerid][pFaction] != FACTION_PEMERINTAH)
        return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari Pemerintah Kota DCRP!");
