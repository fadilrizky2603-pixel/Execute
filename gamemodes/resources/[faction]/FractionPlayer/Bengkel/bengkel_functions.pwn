...
CMD:modif(playerid, params[])
{
    ...
    if(AccountData[playerid][pFaction] != FACTION_BENGKEL) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan bagian dari BENGKEL DCRP!");
    ...
    if(IsAModifArea(playerid))
    {
        ...
        if(AccountData[playerid][pFactionRank] < 3) // Dibawah Senior
        {
            ...
            ShowPlayerDialog(playerid, DIALOG_MODIF, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Modifikasi", minsty, "Pilih", "Batal");
        }
        else
        {
            format(minsty, sizeof(minsty), ""WHITE"Ganti Warna Kendaraan\n");
...
hook OnPlayerEnterDynArea(playerid, STREAMER_TAG_AREA:areaid)
{
    if(AccountData[playerid][pFaction] == FACTION_BENGKEL)
    {
        ...
        {
            ShowKey(playerid, "Locker Bengkel");
        }
...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(newkeys & KEY_WALK && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        if(AccountData[playerid][pFaction] == FACTION_BENGKEL)
        {
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_BENGKEL_LOCKER, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Locker Bengkel",
                "Baju Biasa\ 
            ...
            if(IsPlayerInDynamicArea(playerid, Bengkel_Stuff[BengkelCraft]) && AccountData[playerid][pDutyBengkel])
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_BENGKEL_BRANKASITEM, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Barang Bengkel", 
            ...
            if(IsPlayerInDynamicArea(playerid, Bengkel_Stuff[BengkelBrankas]) && AccountData[playerid][pDutyBengkel])
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_BENGVAULT, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Brankas Bengkel", 
            ...
            if(IsPlayerInDynamicArea(playerid, Bengkel_Stuff[BengkelDesk]))
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_BENGKEL_BOSDESK, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Bos Desk", 
                "Invite\
                \n"GRAY"Kelola Jabatan\
                \nKick\
                \n"GRAY"Lihat Anggota\
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_BENGKEL_GARAGE, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Garasi Bengkel", 
                "Keluarkan Kendaraan\
...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    ...
    switch(dialogid)
    {
        case DIALOG_BENGKEL_BOSDESK:
        {
            ...
            switch(listitem)
            {
                case 0: //invite
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_BENGKEL_INVITE, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Invite", frmxt, "Pilih", "Batal");

                }
                case 1:// Kelola Jabatan
                {
                    mysql_query(dcrp_query, "SELECT * FROM player_characters WHERE Char_Faction = 5 ORDER BY Char_FactionRank DESC");
                    ...
                    if(rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_BENGKELSETRANK, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Set Jabatan", shstr, "Pilih", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Set Jabatan", "Tidak ada Anggota Bengkel!", "Tutup", "");
                    }
                }
                case 2:// Kick Offline / Online
                {
                    ...
                    if(rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_BENGKELKICKMEMBER, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Kick Anggota", shstr, "Kick", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Kick Anggota", "Tidak ada Anggota Bengkel!", "Tutup", "");
                    }
                }
                case 3:// Anggota Online
                {
                    ...
                    format(lstr, sizeof lstr, "%s\n", lstr);
                    Dialog_Show(playerid, ShowOnly, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Anggota", lstr, "Close", "");
                }
                case 4:// Saldo Finansial
                {
                    new frmxt[158];
                    format(frmxt, sizeof(frmxt), "Perusahaan Bengkel DCRP saat ini memiliki saldo sebesar:\ 
                    \n"DARKGREEN"%s", FormatMoney(BengkelMoneyVault));
                    ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Bengkel Money", frmxt, "Tutup", "");
                }
                case 5:// Deposit Saldo
                {
                    ShowPlayerDialog(playerid, DIALOG_DEPOSIT_BENGKEL, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Bengkel Deposit", 
                    "Mohon masukkan nominal deposit untuk saldo perusahaan:", "Input", "Batal");
                }
                case 6:// Withdraw Saldo
                {
                    ShowPlayerDialog(playerid, DIALOG_WITHDRAW_BENGKEL, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Bengkel Withdraw",
        ...
        case DIALOG_DEPOSIT_BENGKEL:
        {
            ...
            mysql_format(dcrp_query, frmtmny, sizeof(frmtmny), "UPDATE `stuffs` SET `bengkelmoneyvault` = %d WHERE `ID` = 0", BengkelMoneyVault);
            mysql_tquery(dcrp_query, frmtmny);
            ShowTDN(playerid, NOTIFICATION_SUKSES, sprintf("Anda berhasil deposit %s untuk Bengkel DCRP", FormatMoney(depocash)));
        }
        case DIALOG_WITHDRAW_BENGKEL:
        {
            ...
            ShowTDN(playerid, NOTIFICATION_SUKSES, sprintf("Anda berhasil withdraw %s dari Bengkel DCRP", FormatMoney(withdrawcash)));
        }
            ...
            switch(listitem)
            {
                case 0: //deposit
                {
                    ...
                    if(rows) 
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_BENGVAULT_DEPOSIT, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Brankas Bengkel", str, "Pilih", "Batal");
                    }
                    else 
                    {
                        AccountData[playerid][menuShowed] = false;
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Brankas Bengkel",
                ...
                case 1: //withdraw
                {
                    ...
                    format(str, sizeof(str), "Nama Item\tJumlah\tBerat (-/-)\n");
                    mysql_query(dcrp_query, "SELECT * FROM `bengkel_brankas` WHERE `PID`=0");
                    if(cache_num_rows() > 0)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_BENGVAULT_WITHDRAW, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Brankas Bengkel", str, "Pilih", "Batal");
                    }
                    else 
                    {
                        AccountData[playerid][menuShowed] = false;
        ...
        case DIALOG_BENGVAULT_DEPOSIT:
        {
            ...
            if(cache_num_rows() > 0)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_BENGVAULT_IN, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas Bengkel", 
                shstr, "Input", "Batal");
            }
        }
        case DIALOG_BENGVAULT_IN:
        {
            ...
            new invstr[1028];
            mysql_format(dcrp_query, shstr, sizeof(shstr), "SELECT * FROM `bengkel_brankas` WHERE `PID`=0 AND `Item` = '%s'", FactionBrankas[playerid][factionBrankasTemp]);
            mysql_query(dcrp_query, shstr);
            new rows = cache_num_rows();
            if(rows > 0)
            {
                mysql_format(dcrp_query, invstr, sizeof(invstr), "UPDATE `bengkel_brankas` SET `Quantity` = `Quantity` + %d WHERE `PID` = 0 AND `Item`='%s'", quantity, FactionBrankas[playerid][factionBrankasTemp]);
                mysql_tquery(dcrp_query, invstr, "OnBengkelDeposit", "i", playerid);
            }
            else 
            {
                mysql_format(dcrp_query, invstr, sizeof(invstr), "INSERT INTO `bengkel_brankas` SET `PID`=0, `Item`='%s', `Model`=%d, `Quantity`=%d", FactionBrankas[playerid][factionBrankasTemp], FactionBrankas[playerid][factionBrankasModel], quantity);
                mysql_tquery(dcrp_query, invstr, "OnBengkelDeposit", "i", playerid);
            }
            AccountData[playerid][menuShowed] = false;
        }
        case DIALOG_BENGVAULT_WITHDRAW:
        {
            ...
            if(cache_num_rows() > 0)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_BENGVAULT_OUT, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas Bengkel",
                shstr, "Input", "Batal");
            }
            else 
            {
                AccountData[playerid][menuShowed] = false;
                ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Brankas Bengkel",
        ...
        case DIALOG_BENGVAULT_OUT:
        {
            ...
            {
                mysql_format(dcrp_query, jts, sizeof(jts), "UPDATE `bengkel_brankas` SET `Quantity`=%d WHERE `ID`=%d", FactionBrankas[playerid][factionBrankasQuant], FactionBrankas[playerid][factionBrankasID]);
                mysql_tquery(dcrp_query, jts);
            }
            else 
            {
                mysql_format(dcrp_query, jts, sizeof(jts), "DELETE FROM `bengkel_brankas` WHERE `ID`=%d", FactionBrankas[playerid][factionBrankasID]);
                mysql_tquery(dcrp_query, jts);
            }
        ...
        {
            if(!response) return ShowTDN(playerid, NOTIFICATION_INFO, "Anda telah membatalkan pilihan");
            if(AccountData[playerid][pFaction] != FACTION_BENGKEL) return ShowTDN(playerid, NOTIFICATION_ERROR, "Anda bukan anggota Bengkel DCRP!");
            ...
            if(cache_num_rows())
            {
                ...
                new strgbg[158];
                mysql_format(dcrp_query, strgbg, sizeof(strgbg), "DELETE FROM `player_vehicles` WHERE `PVeh_OwnerID`=%d AND `PVeh_Faction` = 5", pidrow);
                ...
                foreach(new i : Player)
                {
                    if(AccountData[i][IsLoggedIn] && AccountData[i][pSpawned] && pidrow == AccountData[i][pID])
                    {
                        ...
                        RefreshFactionMap(i);
                        ShowTDN(i, NOTIFICATION_WARNING, "Anda telah dikeluarkan dari faction Bengkel DCRP!");
                    }
                }
        ...
        case DIALOG_BENGKELSETRANK:
        {
            ...
            if(rows)
            {
                ...
                ShowPlayerDialog(playerid, DIALOG_RANK_SET_BENGKEL, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Kelola Jabatan",
        ...
        case DIALOG_RANK_SET_BENGKEL:
        {
            ...
            if(isnull(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_BENGKEL, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Kelola Jabatan", \
            ...
            if(!IsNumeric(inputtext)) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_BENGKEL, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Kelola Jabatan", \
            ...
            if(strval(inputtext) < 1 || strval(inputtext) > AccountData[playerid][pFactionRank]) return ShowPlayerDialog(playerid, DIALOG_RANK_SET_BENGKEL, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Kelola Jabatan", \
        ...
        case DIALOG_BENGKEL_INVITE:
        {
            ...
            mysql_format(dcrp_query, icsr, sizeof(icsr), "UPDATE `player_characters` SET `Char_Faction`= 5, `Char_FactionRank` = 1 WHERE `pID`=%d", AccountData[targetid][pID]);
            mysql_tquery(dcrp_query, icsr);
        ...
        case DIALOG_BENGKEL_BRANKASITEM:
        {
            ...
            switch(listitem)
            {
                case 0:// Repair Kits
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_BENGKEL_BRANKASCONF, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Barang Bengkel", jskc, "Iya", "Batal");
                }
                case 1:// Tools
                {
                    static jskc[512];
        ...
        case DIALOG_BENGKEL_BRANKASCONF:
        {
            ...
            switch(AccountData[playerid][pTempValue])
            {
                case 0://
                {
                    ...
                    PlayerTextDrawSetString(playerid, ProgressBar[playerid][1], "MEMBUAT REPAIR KIT");
        ...
        case DIALOG_BENGKEL_BRANKASREPAIRKIT:
        {
            ...
            {
                ShowPlayerDialog(playerid, DIALOG_BENGKEL_BRANKASREPAIRKIT, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas Bengkel", "Mohon ikuti sesuai format berikut:\n[ambil] [jumlah] atau [depo] [jumlah]\nMohon masukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
                return 1;
            }
            if(!strcmp(option, "ambil", true))
            {
                ...
                repairkit -= amount;
                TakeMoney(playerid, bayar);
                ItemAdd(playerid, "Repair Kit", amount);
                ShowTDN(playerid, NOTIFICATION_SUKSES, "Anda berhasil mengambil Repair Kit!");
                ShowItemBox(playerid, "Repair Kit", sprintf("Received_%dx", amount), 2);
                BrankasBengkel_Save();
            }
            if(!strcmp(option, "depo", true))
            {
                ...
                ItemDelete(playerid, "Repair Kit", amount);
                ShowTDN(playerid, NOTIFICATION_SUKSES, "Anda berhasil memasukan Repair Kit!");
                ShowItemBox(playerid, "Repair Kit", sprintf("Removed_%dx", amount), 2);
                BrankasBengkel_Save();
            }
        }
        case DIALOG_BENGKEL_BRANKASTOOLSKIT:
        {
            ...
            if(sscanf(inputtext, "s[128]d", option, amount))
            {
                ShowPlayerDialog(playerid, DIALOG_BENGKEL_BRANKASTOOLSKIT, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas Bengkel", "Mohon ikuti sesuai format berikut:\n[ambil] [jumlah] atau [depo] [jumlah]\nMohon masukkan tanpa tanda ][ pada kolom dibawah ini:", "Input", "Batal");
                return 1;
            }
            if(!strcmp(option, "ambil", true))
            {
                ...
                toolskit -= amount;
                TakeMoney(playerid, bayar);
                ItemAdd(playerid, "Tools Kit", amount);
                ShowTDN(playerid, NOTIFICATION_SUKSES, "Anda berhasil mengambil Tools Kit!");
                ShowItemBox(playerid, "Tools Kit", sprintf("Received_%dx", amount), 2);
                BrankasBengkel_Save();
            }
            if(!strcmp(option, "depo", true))
            {
                ...
                toolskit += amount;
                GiveMoney(playerid, bayar);
                ItemDelete(playerid, "Tools Kit", amount);
                ShowTDN(playerid, NOTIFICATION_SUKSES, "Anda berhasil memasukan Repair Kit!");
                ShowItemBox(playerid, "Tools Kit", sprintf("Removed_%dx", amount), 2);
                BrankasBengkel_Save();
            }
        }
        ...
        case DIALOG_BENGKEL_GARAGE:
        {
            ...
            switch(listitem)
            {
                case 0: //takeout
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_BENGKELTAKEVEH, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Garasi Bengkel", list, "Pilih", "Batal");
                }
                case 1:// simpan kendaraan
                {
                    ...
                    if(!foundnearby) return ShowTDN(playerid, NOTIFICATION_ERROR, "Tidak ada kendaraan dari Bengkel DCRP milik anda di sekitar!");
                }
                case 2:// Beli Kendaraan
                {
                    ShowPlayerDialog(playerid, DIALOG_BENGKELBUYVEH, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Beli Kendaraan", 
                    "Model\tHarga\
                    \nTow Truck\t$5000\
                ...
                {
                    new frmtdel[151];
                    mysql_format(dcrp_query, frmtdel, sizeof(frmtdel), "SELECT * FROM `player_vehicles` WHERE `PVeh_Faction` = 5 AND `PVeh_OwnerID` = %d", AccountData[playerid][pID]);
                    ...
                    if(rows)
                    {
                        ...
                        ShowPlayerDialog(playerid, DIALOG_BENGKELDELCAR, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Hapus Kendaraan", list, "Hapus", "Batal");
                    }
                    else 
                    {
                        PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
                        return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Hapus Kendaraan", "Anda tidak memiliki kendaraan Bengkel!", "Tutup", "");
                    }
                }
            }
        }
        case DIALOG_BENGKELDELCAR:
        {
            ...
            if(cache_num_rows())
            {
                ...
                if(listitem >= 0 && listitem < cache_num_rows())
                {
                    ...
                    mysql_format(dcrp_query, strgbg, sizeof(strgbg), "DELETE FROM `player_vehicles` WHERE `id` = %d", hapvid);
                    mysql_tquery(dcrp_query, strgbg);
        ...
        case DIALOG_BENGKEL_LOCKER:
        {
            ...
            switch(listitem)
            {
                ...
                case 1:
                {
                    ShowPlayerDialog(playerid, DIALOG_BENGKEL_CLOTHES, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Locker Bengkel", 
        ...
        case DIALOG_MODIF_COLOROPTION:
        {
            ...
            switch(listitem)
            {
                case 0:// Ganti Warna
                {
                    ShowPlayerDialog(playerid, DIALOG_MODIF_WARNA1, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Warna 1", color_string, "Input", "Batal");
                    // ShowPlayerDialog(playerid, DIALOG_MODIF_WARNA1, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Warna 1", "Mohon masukkan ID Color Dimulai Dari Angka 1 - 255\n"YELLOW"(Masukkan Dibawah Sini):", "Input", "Batal");
                }
                case 1:// Paintjob
                {
                    ShowPlayerDialog(playerid, DIALOG_MODIF_PAINTJOB, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Paint Job", "Mohon masukkan ID Paintjob kendaraan dikolom bawah ini:\n"YELLOW"(0 - 1 - 2 (3 Untuk Mengembalikan Ke Default))", "Input", "Batal");
                }
            }
        }
        case DIALOG_MODIF_WARNA1:
        {
            ...
            if(AccountData[playerid][pMechColor1] < 0 || AccountData[playerid][pMechColor1] > 255)
                return ShowPlayerDialog(playerid, DIALOG_MODIF_WARNA1, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Warna 1", "Mohon masukkan ID Color Dimulai Dari Angka 1 - 255\n"YELLOW"(Masukkan Dibawah Sini):", "Input", "Batal");
            
            ShowPlayerDialog(playerid, DIALOG_MODIF_WARNA2, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Warna 2", color_string, "Input", "Batal");
            // ShowPlayerDialog(playerid, DIALOG_MODIF_WARNA2, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Warna 2", "Mohon masukkan ID Color Dimulai Dari Angka 1 - 255\n"YELLOW"(Masukkan Dibawah Sini):", "Input", "Batal");
        }
        case DIALOG_MODIF_WARNA2:
        {
            ...
            if(AccountData[playerid][pMechColor2] < 0 || AccountData[playerid][pMechColor2] > 255)
                return ShowPlayerDialog(playerid, DIALOG_MODIF_WARNA2, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Warna 2", "Mohon masukkan ID Color Dimulai Dari Angka 1 - 255\n"YELLOW"(Masukkan Dibawah Sini):", "Input", "Batal");
        ...
        case DIALOG_MODIF_PAINTJOB:
        {
            ...
            if(AccountData[playerid][pMechColor1] < 0 || AccountData[playerid][pMechColor1] > 3)
                return ShowPlayerDialog(playerid, DIALOG_MODIF_PAINTJOB, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Paint Job", "ERROR: 0 - 1- 2 (3 untuk mengembalikan ke Semula)\n\nMohon masukkan ID Paintjob kendaraan dikolom bawah ini:", "Input", "Batal");
        ...
        case DIALOG_MODIF:
        {
            ...
            switch(listitem)
            {
                case 0:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_COLOROPTION, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Ganti Warna Kendaraan", "Ganti Warna Kendaraan\nPaint Job Kendaraan", "Pilih", "Batal");
				}
				case 1:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_VELG, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE" - Velg", "Offroad\nMega\nWires\nTwist\nGrove\nImport\nAtomic\nAhab\nVirtual\nAccess\nTrance\nShadow\nRimshine\nClassic\nCutter\nSwitch\nDollar\n"RED"> Kembalikan Menjadi Standart", "Confirm", "back");
				}
				case 2:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_SPOILER,DIALOG_STYLE_LIST,""PINK1"DCRP"WHITE" - Spoiler","Wheel Arc. Alien Spoiler\nWheel Arc. X-Flow Spoiler\nTransfender Win Spoiler\nTransfender Fury Spoiler\nTransfender Alpha Spoiler\nTransfender Pro Spoiler\nTransfender Champ Spoiler\nTransfender Race Spoiler\nTransfender Drag Spoiler\n"RED"> Kembalikan Menjadi Standart","Choose","back");
				}
				case 3:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_HOODS, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE" - Hoods", "Fury\nChamp\nRace\nWorx\n", "Confirm", "back");
				}
				case 4:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_VENTS, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE" - Venst", "Oval\nSquare\n", "Confirm", "back");
				}
				case 5:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_LIGHTS, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE" - Lights", "Round\nSquare\n", "Confirm", "back");
				}
				case 6:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_EXHAUSTS, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE" - Exhaust", "Wheel Arc. Alien exhaust\nWheel Arc. X-Flow exhaust\nLow Co. Chromer exhaust\nLow Co. Slamin exhaust\nTransfender Large exhaust\nTransfender Medium exhaust\nTransfender Small exhaust\nTransfender Twin exhaust\nTransfender Upswept exhaust\n"RED"> Kembalikan Menjadi Standart", "Confirm", "back");
				}
				case 7:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_FRONT_BUMPERS, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE" - Front Bumper", "Wheel Arc. Alien Bumper\nWheel Arc. X-Flow Bumper\nLow co. Chromer Bumper\nLow co. Slamin Bumper\n"RED"> Kembalikan Menjadi Standart", "Confirm", "back");
				}
				case 8:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_REAR_BUMPERS, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE" - Rear Bumper", "Wheel Arc. Alien Bumper\nWheel Arc. X-Flow Bumper\nLow co. Chromer Bumper\nLow co. Slamin Bumper\n"RED"> Kembalikan Menjadi Standart", "Confirm", "back");
				}
				case 9:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_ROOFS, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE" - Roofs", "Wheel Arc. Alien\nWheel Arc. X-Flow\nLow Co. Hardtop Roof\nLow Co. Softtop Roof\nTransfender Roof Scoop\n"RED"> Kembalikan Menjadi Standart", "Confirm", "back");
				}
				case 10:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_SIDE_SKIRTS, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE" - Side Kirts", "Wheel Arc. Alien Side Skirt\nWheel Arc. X-Flow Side Skirt\nLocos Chrome Strip\nLocos Chrome Flames\nLocos Chrome Arches \nLocos Chrome Trim\nLocos Wheelcovers\nTransfender Side Skirt\n"RED"> Kembalikan Menjadi Standart", "Confirm", "back");
				}
				case 11:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_BULLBARS, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE" - Bullbas", "Locos Chrome Grill\nLocos Chrome Bars\nLocos Chrome Lights \nLocos Chrome Bullbar", "Confirm", "back");
				}
				case 12:
				{
				...
				case 16:
				{
					ShowPlayerDialog(playerid, DIALOG_MODIF_NEON, DIALOG_STYLE_LIST,""PINK1"DCRP"WHITE" - Neon", 
                    "Merah\
                    \n"GRAY"Biru\
                    \nHijau\
                    \n"GRAY"Kuning\
                ...
                case 17:
                {
                    ShowPlayerDialog(playerid, DIALOG_UPGRADE, DIALOG_STYLE_TABLIST, ""PINK1"DCRP"WHITE"- Upgrade Kendaraan",
...
public CreateToolsKit(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 10)
    {
        ...
        ItemDelete(playerid, "Besi", 15);
        ItemDelete(playerid, "Tembaga", 15);
        ItemDelete(playerid, "Pure Oil", 1);
        ItemAdd(playerid, "Tools Kit", 1);
        ShowItemBox(playerid, "Tools Kit", "Received_1x", 2);
        ShowItemBox(playerid, "Besi", "Removed_15x", 2);
        ShowItemBox(playerid, "Tembaga", "Removed_15x", 2);
        ShowItemBox(playerid, "Pure Oil", "Removed_1x", 2);
    }
    else 
    {
...
public CreateRepairKit(playerid)
{
    ...
    if(AccountData[playerid][ActivityTime] >= 120)
    {
        ...
        ItemDelete(playerid, "Besi", 15);
        ItemDelete(playerid, "Tembaga", 15);
        ItemDelete(playerid, "Petrol", 1);
        ItemAdd(playerid, "Repair Kit", 1);
        ShowItemBox(playerid, "Repair Kit", "Received_1x", 2);
        ShowItemBox(playerid, "Besi", "Removed_15x", 2);
        ShowItemBox(playerid, "Tembaga", "Removed_15x", 2);
        ShowItemBox(playerid, "Petrol", "Removed_1x", 2);
    }
    else 
    {
