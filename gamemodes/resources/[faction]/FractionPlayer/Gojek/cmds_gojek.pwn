...
ShowMenuOrderan(playerid, targetid)
{
    ...
    notes,
    targetid);
    ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Gojek App", frmtmenu, "Tutup", "");
    return 1;
}
...
ShowGofoodMenu(playerid)
{
    ...
    ShowPlayerDialog(playerid, DIALOG_GOFOOD_PESAN, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Gojek App", frmtmenu, "Pilih", "Batal");
    return 1;
}
...
CMD:eg(playerid, params[])
{
    ...
    if(PenumpangAvaible[playerid] == otherid)
    {
        ...
        new icstr[125];
        mysql_format(dcrp_query, icstr, sizeof(icstr), "UPDATE `player_characters` SET `Char_Gopay` = `Char_Gopay` + %d WHERE `pID`=%d", value, AccountData[playerid][pID]);
        mysql_tquery(dcrp_query, icstr);

        mysql_format(dcrp_query, icstr, sizeof(icstr), "UPDATE `player_characters` SET `Char_Gopay` = `Char_Gopay` - %d WHERE `pID`=%d", value, AccountData[otherid][pID]);
        mysql_tquery(dcrp_query, icstr);
...
CMD:cgopay(playerid, params[])
{
    ...
    new icsr[125];
    mysql_format(dcrp_query, icsr, sizeof(icsr), "UPDATE `player_characters` SET `Char_Gopay` = `Char_Gopay` - %d WHERE `pID` = %d", value, AccountData[customerID][pID]);
...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[])
{
    switch(dialogid)
    {
        case DIALOG_PESANGORIDE:
        {
            ...
            if(isnull(inputtext))
            {
                ShowPlayerDialog(playerid, DIALOG_PESANGORIDE, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", 
            ...
            ShowPlayerDialog(playerid, DIALOG_PESANGORIDECONF, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App",
        ...
        case DIALOG_PESANGOCAR:
        {
            ...
            if(isnull(inputtext))
            {
                ShowPlayerDialog(playerid, DIALOG_PESANGOCAR, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", 
            ...
            strpack(AccountData[playerid][pEditingItem], inputtext, 64);
            ShowPlayerDialog(playerid, DIALOG_PESANGOCARPENUMPANG, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App",
        ...
        case DIALOG_PESANGOCARPENUMPANG:
        {
            ...
            ShowPlayerDialog(playerid, DIALOG_PESANGOCARCONF, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App",
            twsmk, "Submit", "Batal");
        }
        ...
        case DIALOG_GOFOOD_PESAN:
        {
            ...
            switch(listitem)
            {
                case 0: //Nasi Goreng
                {
                    ShowPlayerDialog(playerid, DIALOG_PESAN_NASIGORENG, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", "Mohon masukkan berapa jumlah yang ingin dibeli:", "Input", "Batal");
                }
                case 1: //Bakso
                {
                    ShowPlayerDialog(playerid, DIALOG_PESAN_BAKSO, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", "Mohon masukkan berapa jumlah yang ingin dibeli:", "Input", "Batal");
                }
                case 2: //Pecel
                {
                    ShowPlayerDialog(playerid, DIALOG_PESAN_NASIPECEL, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", "Mohon masukkan berapa jumlah yang ingin dibeli:", "Input", "Batal");
                }
                case 3: //Bubur
                {
                    ShowPlayerDialog(playerid, DIALOG_PESAN_BUBUR, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", "Mohon masukkan berapa jumlah yang ingin dibeli:", "Input", "Batal");
                }
                case 4: //susu
                {
                    ShowPlayerDialog(playerid, DIALOG_PESAN_SUSU, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", "Mohon masukkan berapa jumlah yang ingin dibeli:", "Input", "Batal");
                }
                case 5: //ESTEH
                {
                    ShowPlayerDialog(playerid, DIALOG_PESAN_ESTEH, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", "Mohon masukkan berapa jumlah yang ingin dibeli:", "Input", "Batal");
                }
                case 6: //Kopi
                {
                    ShowPlayerDialog(playerid, DIALOG_PESAN_KOPI, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", "Mohon masukkan berapa jumlah yang ingin dibeli:", "Input", "Batal");
                }
                case 7: //Choco
                {
                    ShowPlayerDialog(playerid, DIALOG_PESAN_CHOCOMATCH, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", "Mohon masukkan berapa jumlah yang ingin dibeli:", "Input", "Batal");
                }
                case 8: // 
                {
                ...
                case 9: // selesaikan pesanan
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_PESAN_NOTES, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", "Kemana pesanan ini diantarkan? (Tuliskan catatan kamu kepada driver)", "Input", "Batal");
                }
            }
        }
        case DIALOG_PESAN_NASIGORENG:
        {
            ...
            if(isnull(inputtext))
            {
                ShowPlayerDialog(playerid, DIALOG_PESAN_NASIGORENG, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", 
        ...
        case DIALOG_PESAN_BAKSO:
        {
            ...
            if(isnull(inputtext))
            {
                ShowPlayerDialog(playerid, DIALOG_PESAN_BAKSO, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", 
                "Error: Tidak dapat diisi kosong!\nMohon masukkan berapa jumlah yang ingin dibeli:", "Input", "Batal");
                return 1;
            }
        ...
        case DIALOG_PESAN_NASIPECEL:
        {
            ...
            if(isnull(inputtext))
            {
                ShowPlayerDialog(playerid, DIALOG_PESAN_NASIPECEL, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", 
                "Error: Tidak dapat diisi kosong!\nMohon masukkan berapa jumlah yang ingin dibeli:", "Input", "Batal");
                return 1;
            }
        ...
        case DIALOG_PESAN_BUBUR:
        {
            ...
            if(isnull(inputtext))
            {
                ShowPlayerDialog(playerid, DIALOG_PESAN_BUBUR, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", 
                "Error: Tidak dapat diisi kosong!\nMohon masukkan berapa jumlah yang ingin dibeli:", "Input", "Batal");
                return 1;
            }
        ...
        case DIALOG_PESAN_SUSU:
        {
            ...
            if(isnull(inputtext))
            {
                ShowPlayerDialog(playerid, DIALOG_PESAN_SUSU, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", 
                "Error: Tidak dapat diisi kosong!\nMohon masukkan berapa jumlah yang ingin dibeli:", "Input", "Batal");
                return 1;
            }
        ...
        case DIALOG_PESAN_ESTEH:
        {
            ...
            if(isnull(inputtext))
            {
                ShowPlayerDialog(playerid, DIALOG_PESAN_ESTEH, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", 
                "Error: Tidak dapat diisi kosong!\nMohon masukkan berapa jumlah yang ingin dibeli:", "Input", "Batal");
                return 1;
            }
        ...
        case DIALOG_PESAN_KOPI:
        {
            ...
            if(isnull(inputtext))
            {
                ShowPlayerDialog(playerid, DIALOG_PESAN_KOPI, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", 
                "Error: Tidak dapat diisi kosong!\nMohon masukkan berapa jumlah yang ingin dibeli:", "Input", "Batal");
                return 1;
            }
        ...
        case DIALOG_PESAN_CHOCOMATCH:
        {
            ...
            if(isnull(inputtext))
            {
                ShowPlayerDialog(playerid, DIALOG_PESAN_CHOCOMATCH, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", 
                "Error: Tidak dapat diisi kosong!\nMohon masukkan berapa jumlah yang ingin dibeli:", "Input", "Batal");
                return 1;
            }
        ...
        case DIALOG_PESAN_NOTES:
        {
            ...
            if(isnull(inputtext))
            {
                ShowPlayerDialog(playerid, DIALOG_PESAN_NOTES, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Gojek App", 
