...
CMD:setrender(playerid, params[])
{
	...
	Dialog_Show(playerid, StreamerSetting, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Render Setting", str, "Pilih", "Batal");
	return 1;
}*/
...
/*CMD:setrender(playerid, params[])
{
	...
	ShowPlayerDialog(playerid, DIALOG_STREAMER_CONFIG, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Render Settings",
	"Jenis\tRadius\
	\nSoft\t300.0\
	\n"GRAY"Medium\t500.0\
		...
		case DIALOG_STREAMER_CONFIG:
		{
			...
			switch(listitem)
			{
				case 0: // soft
				{
					...
					Info(playerid, "Anda berhasil mengubah dynamic render object to "GREEN"Sangat rendah");
				}
				case 1: // soft
				{
					...
					Streamer_SetVisibleItems(STREAMER_TYPE_OBJECT, AccountData[playerid][pMapRender], playerid);
					Streamer_SetRadiusMultiplier(STREAMER_TYPE_OBJECT, AccountData[playerid][pMapSettings], playerid);
					Info(playerid, "Anda berhasil mengubah dynamic render object to "GREEN"Rendah");
				}
				case 2: //medium
				{
					...
					Streamer_SetVisibleItems(STREAMER_TYPE_OBJECT, AccountData[playerid][pMapRender], playerid);
					Streamer_SetRadiusMultiplier(STREAMER_TYPE_OBJECT, AccountData[playerid][pMapSettings], playerid);
					Info(playerid, "Anda berhasil mengubah dynamic render object to "GREEN"Sedang");
				}
				case 3: //High
				{
					...
					Streamer_SetVisibleItems(STREAMER_TYPE_OBJECT, AccountData[playerid][pMapRender], playerid);
					Streamer_SetRadiusMultiplier(STREAMER_TYPE_OBJECT, AccountData[playerid][pMapSettings], playerid);
					Info(playerid, "Anda berhasil mengubah dynamic render object to "GREEN"Tinggi");
				}
			}
