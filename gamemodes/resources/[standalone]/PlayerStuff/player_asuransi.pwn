...
hook OnGameModeInit()
{
	CreateDynamic3DTextLabel(""GREEN"[ALT]"WHITE"- Asuransi Kendaraan", -1, 424.42, -1318.80, 14.99 + 0.3, 10.0, INVALID_PLAYER_ID, INVALID_VEHICLE_ID, 1);// LS
