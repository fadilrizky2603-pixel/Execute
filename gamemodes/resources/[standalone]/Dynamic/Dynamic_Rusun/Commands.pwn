...
hook OnPlayerKeyStateChange(playerid, newkeys, oldkeys)
{
    if(newkeys & KEY_WALK && GetPlayerState(playerid) == PLAYER_STATE_ONFOOT)
    {
        ...
        if(AccountData[playerid][pInRusun] != -1 && IsPlayerInRangeOfPoint(playerid, 1.5, RusunsData[AccountData[playerid][pInRusun]][rIntPos][0], RusunsData[AccountData[playerid][pInRusun]][rIntPos][1], RusunsData[AccountData[playerid][pInRusun]][rIntPos][2]))
        {
            ...
            PlayerTextDrawSetString(playerid, ProgressBar[playerid][1], "OUT");
        ...
        {
            Dialog_Show(playerid, RUSUN_BRANKAS, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- %s",
            "Undang\
            \n"GRAY"Pakaian\
            \nMembuang Pakaian\
        ...
        if ((rsid = Rusun_Nearest(playerid)) != -1)
        {
            if (RusunsData[rsid][rOwnerID] != 0)
            {
                if (RusunsData[rsid][rOwnerID] != AccountData[playerid][pID])
                {
                    ...
                    ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, sprintf(""PINK1"DCRP"WHITE"- %s", RusunsData[rsid][rName]), 
                    "Sudah dimiliki warga lain!", "Tutup", "");
                }
                else
                {
                    AccountData[playerid][pInRusun] = rsid;
                    Dialog_Show(playerid, RUSUN_OWNED, DIALOG_STYLE_LIST, sprintf(""PINK1"DCRP"WHITE"- %s", RusunsData[rsid][rName]),
                    "Masuk\
            ...
            {
                AccountData[playerid][pInRusun] = rsid;
                Dialog_Show(playerid, RUSUN_MENU, DIALOG_STYLE_TABLIST, sprintf(""PINK1"DCRP"WHITE"- %s", RusunsData[rsid][rName]),
...
Dialog:RUSUN_OWNED(playerid, response, listitem, inputtext[])
{
    ...
    switch(listitem)
    {
        case 0: // Maasuk
        {
            ...
            AccountData[playerid][ActivityTime] = 1;
            PlayerTextDrawSetString(playerid, ProgressBar[playerid][1], "ENTERING");
            ShowProgressBar(playerid);
...
Dialog:RUSUN_BRANKAS(playerid, response, listitem, inputtext[])
{
    ...
    switch(listitem)
    {
        case 0:
        {
            ...
            Dialog_Show(playerid, RUSUN_INVITE, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Undang Teman", frmxt, "Pilih", "Batal");
        }
        case 1:
        {
        ...
        case 3:
        {
            Dialog_Show(playerid, RUSUN_BROPTION, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Brankas",
...
Dialog:RUSUN_INVITE(playerid, response, listitem, inputtext[])
{
    ...
    if ((id = RusunInside(playerid)) != -1)
    {
        ...
        Dialog_Show(targetid, RUSUN_INVITECONF, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Undang Teman",
    ...
    switch(listitem)
    {
        case 0: //deposit
        {
            ...
            if(cache_num_rows() > 0)
            {
                ...
                Dialog_Show(playerid, RUSUNVAULT_DEPOSIT, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Brankas", str, "Pilih", "Batal");
            }
            else 
            {
                PlayerPlaySound(playerid, 5206, 0.0, 0.0, 0.0);
        ...
        case 1: //withdraw
        {
            ...
            if(cache_num_rows() > 0)
            {
                ...
                Dialog_Show(playerid, RUSUNVAULT_WITHDRAW, DIALOG_STYLE_TABLIST_HEADERS, ""PINK1"DCRP"WHITE"- Brankas", str, "Pilih", "Batal");
            }
            else 
            {
                return ShowPlayerDialog(playerid, DIALOG_UNUSED, DIALOG_STYLE_MSGBOX, ""PINK1"DCRP"WHITE"- Brankas",
...
Dialog:RUSUNVAULT_DEPOSIT(playerid, response, listitem, inputtext[])
{
    ...
    if(cache_num_rows() > 0)
    {
        if(listitem >= 0 && listitem < cache_num_rows())
        {
            ...
            Dialog_Show(playerid, RUSUNVAULT_IN, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas",
            shstr, "Input", "Batal");
        }
    }
    return 1;
...
Dialog:RUSUNVAULT_IN(playerid, response, listitem, inputtext[])
{
    ...
    if(cache_num_rows() > 0)
    {
        ...
        mysql_tquery(dcrp_query, invstr, "OnRusunDepo", "d", playerid);
    }
    else
    {
...
Dialog:RUSUNVAULT_WITHDRAW(playerid, response, listitem, inputtext[])
{
    ...
    if(cache_num_rows() > 0)
    {
        if(listitem >= 0 && listitem < cache_num_rows())
        {
            ...
            Dialog_Show(playerid, RUSUNVAULT_OUT, DIALOG_STYLE_INPUT, ""PINK1"DCRP"WHITE"- Brankas",
            shstr, "Input", "Batal");
        }
    }
    return 1;
