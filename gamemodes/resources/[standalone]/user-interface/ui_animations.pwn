...
bool: IsPlayerPlayingAnimation(playerid, const animlib[], const animname[])
{
...
CMD:eilist(playerid, params[])
{
	...
	Dialog_Show(playerid, ShowOnly, DIALOG_STYLE_LIST, ""PINK1"DCRP"WHITE"- Anim Interaksi", xjjs, "Tutup", "");
	return 1;
}
