...
//ucp data
//new ucp::data[MAX_PLAYERS][MAX_CHARS][E_UCPDATA];
new PlayerChar[MAX_PLAYERS][MAX_CHARS][MAX_PLAYER_NAME + 1];
new CharSkin[MAX_PLAYERS][MAX_CHARS];
...
new PlayerCameraView[MAX_PLAYERS]; // 0 = belakang, 1 = kanan, 2 = depan, 3 = kiri



new TogIsiBensin[MAX_PLAYERS];
new STREAMER_TAG_AREA:PantaiArea[MAX_PLAYERS];
