#define TEXT_GAMEMODE	"DCRP 0.2.0"
#define TEXT_WEBURL		"dsc.gg/dcrp"
#define TEXT_LANGUAGE	"Bahasa Indonesia"
#define SERVER_BOT      "DCRP BOT"
#define SERVER_NAME     "DCRP PROJECT"

//hosting
/*#define        MYSQL_HOST             "db2.sampryzen.com"
#define        MYSQL_USER             "u1146_PtP45NIIX0"
#define        MYSQL_PASSWORD         "mN=9@!+PWfUpNIZO2SdwYJtd"
#define        MYSQL_DATABASE         "s1146_DEVINE_samp"*/

//hosting
#define		MYSQL_HOST 	        "localhost"
#define		MYSQL_USER 		    "root"
#define		MYSQL_PASSWORD 		""
#define		MYSQL_DATABASE 		"Murozxz"

/*#define		MYSQL_HOST 			"localhost"
#define		MYSQL_USER 			"root"
#define		MYSQL_PASSWORD 		""
#define		MYSQL_DATABASE 		"fcode"*/
...
#define Info(%1,%2) SendClientMessageEx(%1, 0x2E8B57AA, "[Info]: "WHITE""%2)
...
#define SendCustomMessage(%0,%1,%2)     SendClientMessageEx(%0, 0xC0C0C0FF, %1": "WHITE""%2)

#define function%0(%1) forward %0(%1); public %0(%1)
#define forex(%0,%1) for(new %0 = 0; %0 != %1; %0++)
#define jv_loop(%0,%1) for(new %0=0; %0<%1; %0++)
...
// Function
#define JadenDCRP:%0(%1) forward %0(%1); public %0(%1)
#define FUNC::%0(%1) forward %0(%1); public %0(%1)
#define NERO::%0(%1) forward %0(%1); public %0(%1)
...
#define RETURN_INVALID_VEHICLE_ID   65535
...
//#define MAX_FACTION_VEHICLE 1000
